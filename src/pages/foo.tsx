  ...
  export default function MyReactPage() {
    const htmlContent = `<div class="sect1">
...
<pre>locals {
  ...
  excluded_child_account_ids = (
    ...
    : [
      ...
      : account.id <span class="hljs-keyword">if</span> <span class="hljs-title function_">lookup</span><span class="hljs-params">(lookup(<span class="hljs-keyword">var</span>.child_accounts, account_name, {})</span>, <span class="hljs-string">&quot;enable_config_rules&quot;</span>, <span class="hljs-literal">false</span>) == <span class="hljs-literal">false</span>
    ]
  )
}</pre>
</div>
