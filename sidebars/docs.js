      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            link: {
              type: "doc",
              id: "2.0/docs/pipelines/guides/hooks/gruntwork-provided",
            },
            // Autogenerated so a released hook, and every version frozen under previous/, reaches
            // the sidebar without an edit here. The pages are generated in another repository.
            // The overview sits beside the directory rather than in it: an index.md inside would
            // be listed as an item as well as being this category's link.
            items: [
              {
                type: "autogenerated",
                dirName: "2.0/docs/pipelines/guides/hooks/gruntwork-provided",
              },
            ],
          },
        ],
