...
1. Enable developers to move fast ([velocity](/docs/way/why/velocity))
2. ...while meeting the other needs of the business like security, cost, and compliance ([governance](/docs/way/why/governance))
3. ...without accumulating an unsustainable level of debt ([maintainability](/docs/way/why/maintainability))
...
- [Patterns](/docs/way/platform/patterns/overview) - pre-built solutions to common infrastructure problems
- [Platform components](/docs/way/platform/components/overview) - the machinery for deploying and managing infrastructure
- [Interfaces](/docs/way/platform/interfaces/overview) - how developers interact with your platform.
