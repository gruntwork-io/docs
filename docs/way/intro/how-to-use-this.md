...
First, a **developer platform** is the product your platform team builds to balance three essential concerns: enabling developers to move fast ([velocity](/docs/way/why/velocity)), meeting business needs like security, cost, and compliance ([governance](/docs/way/why/governance)), and avoiding unsustainable technical debt ([maintainability](/docs/way/why/maintainability)).

To build a successful platform, you need to combine three types of building blocks: [patterns](/docs/way/platform/patterns/overview) (pre-built solutions to common infrastructure problems), [platform components](/docs/way/platform/components/overview) (the machinery for deploying and managing infrastructure), and [interfaces](/docs/way/platform/interfaces/overview) (how developers interact with your platform).

Finally, everything in this framework is based on the [guiding principles](/docs/way/principles/overview) we've discovered through years of building and refining developer platforms.
