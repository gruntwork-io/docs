...
_Related: [Drift detector component](/docs/way/platform/components/maintain/drift-detector)_
...
_Related: [Importer component](/docs/way/platform/components/maintain/importer)_
...
_Related: [IaC updater component](/docs/way/platform/components/maintain/iac-updater)_
...
_Related: [Scorecard component](/docs/way/platform/components/maintain/scorecard)_
...
You can evaluate how well these standards are applied at the repo, environment, or [unit](/docs/way/resources/glossary#unit) level. You can measure each standard as either a binary value (complies / does not comply) or range value (e.g. 0 to 10).
