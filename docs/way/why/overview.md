...
In [principles](/docs/way/principles/overview), we share a set of principles we embrace when it comes to designing a developer platform.

In [building blocks](/docs/way/platform/overview), we describe the three major elements of a developer platform: 
