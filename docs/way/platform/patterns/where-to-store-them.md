...
Once you define a pattern, you need somewhere to store it. This is the core purpose of the **[catalog](/docs/way/platform/components/deploy/catalog)** platform component.
