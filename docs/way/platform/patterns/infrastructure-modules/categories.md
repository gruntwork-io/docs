...
Earlier, we [defined](/docs/way/platform/patterns/overview) patterns as _pre-built opinionated solutions to common infrastructure problems._ So what exactly are those common infrastructure problems? 
