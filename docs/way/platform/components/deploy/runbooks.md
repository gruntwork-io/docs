...
When a developer needs to deploy new infrastructure, per the principle of [define all live infrastructure as pattern instances](/docs/way/principles/technical-foundations/define-all-live-infrastructure-as-pattern-instances), the developer will need a way to create a new [infrastructure module instance](/docs/way/platform/patterns/types#infrastructure-module-instances). 
...
- Write new code that calls the desired [infrastructure module](/docs/way/platform/patterns/types#infrastructure-modules) (e.g. a Terragrunt unit)
...
Specifically, developer self-service is the combination of a **[catalog](/docs/way/platform/components/deploy/catalog)** of infrastructure modules, plus the ability to use **runbooks,** plus a way to deploy the generated code using a **[pipeline](/docs/way/platform/components/deploy/pipelines)**.
...
- **Generate code.** The user can instantiate an [infrastructure module](/docs/way/platform/patterns/types#infrastructure-modules), either by generating code or other means.
