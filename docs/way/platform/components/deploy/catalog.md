...
The catalog is the system of record for all your organization's [infrastructure patterns](/docs/way/platform/patterns/overview).
...
- **Browsable.** Users can browse the available patterns using their preferred [interface](/docs/way/platform/interfaces/overview).
...
- **Connect to self-service.** When user identifies a pattern they want to instantiate, the catalog directs them right to the applicable [runbook](/docs/way/platform/components/deploy/runbooks).
