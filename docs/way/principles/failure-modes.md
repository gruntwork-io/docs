...
### What went wrong
You violated the principle that [your developer platform is a product](/docs/way/principles/core-philosophy/your-developer-platform-is-a-product).
...
You ignored [maintainability](/docs/way/why/maintainability) concerns until technical debt overwhelmed your ability to operate.
...
You didn't establish [centralized standards](/docs/way/principles/governance-maintainability/offer-golden-paths) soon enough and your platform's surface area has become unmanageable.
...
Apply the principle of centralized standards, decentralized execution. Make opinionated choices about tooling and patterns at the center, then build ["golden paths"](/docs/way/principles/governance-maintainability/offer-golden-paths) for these standards. Show developer teams that when they use official standards, they get a large collection of supported tooling. 
...
You (or your developer teams) didn't leverage [pre-built patterns](/docs/way/principles/developer-experience/pre-built-patterns-are-your-leverage) when populating your [catalog](/docs/way/platform/patterns/overview), so you effectively reimplemented the same solutions from scratch.
...
[Pre-built patterns are your leverage](/docs/way/principles/developer-experience/pre-built-patterns-are-your-leverage). 

First, as platform engineers, look for pre-built, battle-tested patterns wherever possible. These could be open source modules, or commercial module catalogs like the [Gruntwork AWS IaC Library](https://docs.gruntwork.io/docs/aws-accelerator/library/concepts/overview).
...
Combine these patterns with [self-service](/docs/way/principles/developer-experience/enable-developer-self-service) so developers can provision infrastructure on demand without waiting for approvals. Build compliance and security into these patterns so [good practices become the easy default](/docs/way/principles/developer-experience/make-good-practices-the-default).