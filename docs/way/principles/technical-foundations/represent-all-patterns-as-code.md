...
We talked earlier about how [pre-built patterns are your leverage](/docs/way/principles/developer-experience/pre-built-patterns-are-your-leverage). To realize that principle in practice, those patterns should be represented as code.
...
:::info
Patterns are a fundamental concept of developer platforms. Learn much more about them in the [Patterns section](/docs/way/platform/patterns/overview).
:::
