...
Account Factory uses Gruntwork's [AWS Control Tower Multi Account Factory](https://library.gruntwork.io/modules/terraform-aws-control-tower/control-tower-multi-account-factory/) and Pipelines to automate account creation, baselining, and IAM policy management.
