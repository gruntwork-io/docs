...
Account Factory relies on Pipelines to drive infrastructure changes via GitOps workflows, so make sure to read the [Pipelines security controls](/docs/terragrunt-scale/pipelines/architecture/security-controls) for more details on how Pipelines secures workflows.
...
- [GitHub Machine Users](/docs/terragrunt-scale/pipelines/installation/viamachineusers)
...
See [Setup via Machine Users](/docs/terragrunt-scale/pipelines/installation/viamachineusers) for more details.
