...
2. Through Gruntwork Account Factory:
   ...
   - Automatically keep AWS account baselines up-to-date with [Patcher](/docs/terragrunt-scale/patcher/concepts/).
...
- [Install Gruntwork Pipelines](/docs/terragrunt-scale/pipelines/installation/viagithubapp).
- [Set up Gruntwork Account Factory](/docs/aws-accelerator/account-factory/installation).
