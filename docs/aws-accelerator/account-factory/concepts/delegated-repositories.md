...
Delegated repositories can be optionally created by the [Account Factory](/docs/aws-accelerator/account-factory/concepts) as part of the account provisioning process. The workflow for vending a delegated account follows these automated steps:
