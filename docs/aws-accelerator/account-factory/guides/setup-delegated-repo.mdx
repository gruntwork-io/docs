...
:::note
[Automatic vending of delegated repositories by Account Factory](/docs/aws-accelerator/account-factory/guides/delegated-repositories.md) is an Enterprise-only feature.  GitLab support is coming soon.
...
Infrastructure management delegation is a key feature in DevOps Foundations. To learn more about delegated repositories, click [here](/docs/aws-accelerator/account-factory/architecture/#delegated-repositories).
...
The following guide assumes you have completed the [Pipelines Setup & Installation](/docs/aws-accelerator/account-factory/prerequisites/awslandingzone).
...
The [infrastructure-live-access-control](/docs/terragrunt-scale/pipelines/architecture/security-controls.md#infrastructure-access-control) repository is an optional but recommended component of DevOps Foundations for delegating access to infrastructure.
