...
Account Factory options are defined in the `.gruntwork/config.yml` file. For a full description of all available options, refer to the [configuration reference](/docs/aws-accelerator/account-factory/reference/configurations).
...
[catalog-repositories](/docs/aws-accelerator/account-factory/reference/configurations#catalog-repositories)
...
[github-collaborators](/docs/aws-accelerator/account-factory/reference/configurations#github-collaborators)
