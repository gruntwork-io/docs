...
GitHub collaborators are defined in the [account-factory configuration](/docs/aws-accelerator/account-factory/reference/configurations#github-collaborators).
