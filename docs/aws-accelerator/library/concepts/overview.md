...
Refer to [Modules](/docs/aws-accelerator/library/concepts/modules) for additional details.
...
Refer to [Service Modules](/docs/aws-accelerator/library/concepts/service-modules) to learn more.
