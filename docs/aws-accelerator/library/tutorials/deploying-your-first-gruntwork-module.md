...
In this guide, you will learn how to create an AWS Lambda function using a module from the Gruntwork IaC Library. You’ll also learn how to structure your IaC code to support multiple deployments. The same steps apply when using a [service](/docs/aws-accelerator/library/concepts/service-modules), as you can reference both modules and services in module blocks.
