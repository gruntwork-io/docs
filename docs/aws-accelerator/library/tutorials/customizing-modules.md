...
If you believe your change will benefit the entire Gruntwork community using the module, you can [create a pull request](https://help.github.com/articles/creating-a-pull-request/) with your changes. Refer to [contributing](/docs/aws-accelerator/library/guides/contributing) for more details.
...
Using forked code is similar to the process outlined in [Deploying your first Gruntwork Module](/docs/aws-accelerator/library/tutorials/deploying-your-first-gruntwork-module), with the following adjustments:
