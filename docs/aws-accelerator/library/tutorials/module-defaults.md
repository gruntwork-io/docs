...
Now that you have an understanding of [what module defaults are](/docs/aws-accelerator/library/concepts/module-defaults), you can develop your own defaults module.
