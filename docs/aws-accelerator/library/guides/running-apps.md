...
- **Updates.** Gruntwork regularly publishes updates to EKS, ECS, and Lambda modules. You can use [Patcher](/docs/terragrunt-scale/patcher/concepts/) to automate updates to the latest versions of these modules.
