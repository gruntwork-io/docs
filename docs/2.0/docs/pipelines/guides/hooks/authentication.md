...
For a working example using AWS and SSM Parameter Store, see [Slack Deploy Notification](/2.0/docs/pipelines/tutorials/slack-deploy-notification). For other ways to manage and supply secrets across Pipelines, see [Managing Secrets in your Pipelines](/2.0/docs/pipelines/guides/managing-secrets).
