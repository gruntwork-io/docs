...
<PersistentCheckbox id="clone-repository" label="Clone the `infrastructure-live` repository locally." />
...
<PersistentCheckbox id="uncomment-remote-state-backend" label="Uncomment the section that defines the remote state backend in the `root.hcl` file." />
...
<PersistentCheckbox id="scaffold-additional-subscription" label="Use Boilerplate to scaffold out additional Azure subscriptions." />
...
<PersistentCheckbox id="comment-out-remote-state-backend" label="Comment out the remote state backend configurations in the `root.hcl` file." />
...
<PersistentCheckbox id="run-additional-azure-plan" label="Run a plan in the bootstrap directory of the additional subscription to make sure that everything is set up correctly." />
<PersistentCheckbox id="run-additional-azure-apply" label="Run an apply in the bootstrap directory of the additional subscription to provision the resources in the additional subscription." />
...
<PersistentCheckbox id="uncomment-remote-state-backend" label="Uncomment the remote state backend configurations in the `root.hcl` file." />
