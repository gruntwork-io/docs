...
<PersistentCheckbox
  id="run-azure-plan"
  label="Run a plan in the subscription directory to preview changes."
/>
...
<PersistentCheckbox
  id="run-azure-init-migrate-state-force-copy"
...
<PersistentCheckbox
  id="run-additional-azure-init-migrate-state-force-copy"
  label="Pull the resources into state using Terragrunt."
/>
