...
Infrastructure management delegation is a key feature in AWS Accelerator. To learn more about delegated repositories, click [here](/2.0/docs/accountfactory/architecture/#delegated-repositories).
