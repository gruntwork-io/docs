...
### Gruntwork Platform {#gruntwork-aws-accelerator}

**Gruntwork Platform** is a comprehensive solution for organizations deploying infrastructure on AWS. It includes:
