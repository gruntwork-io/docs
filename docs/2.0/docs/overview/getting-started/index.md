...
Follow Gruntwork's AWS Landing Zone walkthrough to implement a best-practice multi-account setup, ready for use with Gruntwork Platform.
...
During the Pipelines setup process, configure Gruntwork AWS Account Factory for AWS account management.
