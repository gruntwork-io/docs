...
As you can see, it takes a lot to get a pattern right, but when you do, your consumers can achieve [velocity](/2.0/way/why/velocity), [governance](/2.0/way/why/governance), and [maintainability](/2.0/way/why/maintainability) with relative ease.