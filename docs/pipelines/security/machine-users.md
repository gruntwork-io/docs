...
- `ORG_REPO_ADMIN_TOKEN`
  ...
  1. **Repository access**. Using the `Selected repositories` option select the `infrastructure-live-root` repository.
...
After the bootstrap process is complete, you can delete the following token for security purposes if you are a Teams customer:
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "f459c23777b6a5a98372d5f888aa0238"
}
##DOCS-SOURCER-END -->
