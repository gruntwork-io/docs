...
:::tip
While we recommend creating two machine users for this use case, you can create more or fewer, depending on the needs of your organization.

What is required is that the correct tokens are created, and that the permissions for the machine user(s) and tokens are appropriate for the access they need.
:::
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "a186a4aec2caf423aef4df4b36186c06"
}
##DOCS-SOURCER-END -->
