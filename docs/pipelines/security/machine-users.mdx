...
:::tip
We recommend creating two machine users for this use case but you can adjust based on your organization's need. Simply ensure the correct tokens are created and the permissions for the machine users and tokens are appropriate for their required access.
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "05f548e290d92db1948e56afc6a2e2de"
}
##DOCS-SOURCER-END -->
