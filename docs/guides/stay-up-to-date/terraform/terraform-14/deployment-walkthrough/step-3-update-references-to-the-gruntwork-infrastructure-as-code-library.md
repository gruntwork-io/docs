...
the proper versions of the Gruntwork library to pick up the fixes/changes that we made to be compatible. Refer to our ["Updating to new versions"](/2.0/docs/library/guides/updating-modules/) guide for instructions on how to update the
...
{/* ##DOCS-SOURCER-START
{
  ...
  "hash": "67189e5711133b31156e73a927df1451"
}
##DOCS-SOURCER-END */}
