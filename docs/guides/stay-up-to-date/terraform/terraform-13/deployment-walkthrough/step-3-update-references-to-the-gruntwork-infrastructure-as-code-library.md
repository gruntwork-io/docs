...
the proper versions of the Gruntwork library to pick up the fixes/changes that were made to be compatible. Refer to our ["Updating to new versions"](/iac/stay-up-to-date/updating) guide for instructions on how to update the
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "2562afbdbfa6813ede25a7a643623288"
}
##DOCS-SOURCER-END -->
