...
the proper versions of the Gruntwork library to pick up the fixes/changes that were made to be compatible. Refer to our ["Updating to new versions"](/2.0/docs/library/guides/updating-modules/) guide for instructions on how to update the
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "e5411f4646be9ced2e01e23dd993fa41"
}
##DOCS-SOURCER-END -->
*/}
