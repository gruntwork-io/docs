...
the proper versions of the Gruntwork library to pick up the fixes/changes that we made to be compatible. Refer to our ["Updating to new versions"](/iac/stay-up-to-date/updating) guide for instructions on how to update the
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "eff9ce97b775382c77f36dd08bb0c3cd"
}
##DOCS-SOURCER-END -->
