...
1.  Update your code to work with Terraform 0.12. Do NOT skip from, say, 0.11, straight to 0.13. You MUST update to
    ...
    [Terraform 0.12 upgrade guide](../../how-to-update-to-terraform-12/intro.md) for instructions.
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"Local File Copier","hash":"0b5b02cf896fb0cc739809ea23a0862a"}
##DOCS-SOURCER-END -->
