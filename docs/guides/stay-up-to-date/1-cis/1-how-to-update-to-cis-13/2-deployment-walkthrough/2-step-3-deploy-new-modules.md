...
[relevant section](../../../../build-it-yourself/6-achieve-compliance/2-production-grade-design/1-identity-and-access-management.md#cleanup-expired-ssl-tls-certificates)
...
For the code examples of deploying this module, see the
[relevant section](../../../../build-it-yourself/6-achieve-compliance/2-production-grade-design/1-identity-and-access-management.md#iam-access-analyzer)
of our "How to achieve compliance with the CIS AWS Foundations Benchmark" guide.
...
For the code examples of deploying this module, see the
[relevant section](../../../../build-it-yourself/6-achieve-compliance/2-production-grade-design/2-storage.md#configure-ebs-encryption)
...
For the code examples of deploying this module, see the
[relevant section](../../../../build-it-yourself/6-achieve-compliance/2-production-grade-design/5-networking.md)
of our "How to achieve compliance with the CIS AWS Foundations Benchmark" guide.
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"Local File Copier","hash":"5f4d1c8bd0169088f640bfb7852cfe78"}
##DOCS-SOURCER-END -->
