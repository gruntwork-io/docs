...
the proper versions of the Gruntwork IaC Library to pick up the fixes/changes made to be compatible. Refer to our ["Updating to new versions"](/2.0/docs/library/guides/updating-modules/) guide for instructions on how to update the
versions in your code.

Gruntwork follows
[semantic
versioning](/2.0/docs/library/guides/versioning/). For any pre-1.0 modules, this means that version updates to the minor version are considered backward
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "475e87e525c5323dd80e88c2c9cbd270"
}
##DOCS-SOURCER-END -->
*/}
