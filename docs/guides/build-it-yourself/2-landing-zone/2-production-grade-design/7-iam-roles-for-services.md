...
subnets so that it is NOT accessible from the public Internet (see [How to deploy a production-grade VPC on AWS](../../4-vpc/0-intro/0-what-youll-learn-in-this-guide.md)).
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"Local File Copier","hash":"3935414827d6a2b3b8d5b8b598047a51"}
##DOCS-SOURCER-END -->
