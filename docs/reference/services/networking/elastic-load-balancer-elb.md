...
<VersionBadge version="2.5.0" lastModifiedVersion="2.4.0"/>

# Application Load Balancer

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.5.0/modules/networking/alb" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.5.0/modules/networking/alb/variables.tf",
