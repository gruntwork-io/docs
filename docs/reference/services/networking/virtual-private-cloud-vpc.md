...
<VersionBadge version="2.14.0" lastModifiedVersion="2.14.0"/>

# VPC

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.14.0/modules/networking/vpc" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
*   [examples/for-learning-and-testing folder](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.14.0/examples/for-learning-and-testing): The
...
module "vpc" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/networking/vpc?ref=v2.14.0"
...
<HclListItem name="flow_log_cloudwatch_kms_key_arn">
<HclListItemDescription>

The ARN of the KMS key used to encrypt VPC Flow Logs delivered to CloudWatch Logs, if one was created.
...
The ARN of the CloudWatch Logs group where VPC Flow Logs are published. Only set when flow_log_destination_type is cloud-watch-logs.

</HclListItemDescription>
</HclListItem>

<HclListItem name="flow_log_cloudwatch_log_group_name">
<HclListItemDescription>

The name of the CloudWatch Logs group where VPC Flow Logs are published. Only set when flow_log_destination_type is cloud-watch-logs.
...
<HclListItem name="flow_log_s3_bucket_arn">
<HclListItemDescription>

The ARN of the S3 bucket where VPC Flow Logs are published. Only set when flow_log_destination_type is s3 and a bucket is created by this module.

</HclListItemDescription>
</HclListItem>

<HclListItem name="flow_log_s3_bucket_name">
<HclListItemDescription>

The name of the S3 bucket where VPC Flow Logs are published. Only set when flow_log_destination_type is s3 and a bucket is created by this module.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.14.0/modules/networking/vpc/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.14.0/modules/networking/vpc/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.14.0/modules/networking/vpc/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "7cefe2eb475a5a8ecd0dbfb57d09f91e"
}
##DOCS-SOURCER-END -->
