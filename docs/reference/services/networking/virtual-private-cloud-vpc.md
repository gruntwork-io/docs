...
module "vpc" {
  ...
  # Filters to select the IPAM pool to use for allocated this VPCs
  ipam_pool_filters = null
...
<HclListItem name="ipam_pool_filters" requirement="optional" type="list(object(…))">
<HclListItemDescription>
