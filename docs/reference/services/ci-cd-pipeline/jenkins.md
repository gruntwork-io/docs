...
<VersionBadge version="0.118.19" lastModifiedVersion="0.118.9"/>

# Jenkins CI Server

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.19/modules/mgmt/jenkins" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "jenkins" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/mgmt/jenkins?ref=v0.118.19"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.19/modules/mgmt/jenkins/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.19/modules/mgmt/jenkins/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.19/modules/mgmt/jenkins/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "c7b4110a457c6359b4597d1ebb30a9d3"
}
##DOCS-SOURCER-END -->
