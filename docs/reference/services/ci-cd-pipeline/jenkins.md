...
<Tabs>
  <TabItem value="inputs" label="Inputs" default>
    <table>
        ...
        <tbody>
            <tr>
        <td><a name="acm_ssl_certificate_domain" href="#acm_ssl_certificate_domain" className="snap-top"><code>acm_ssl_certificate_domain</code></a></td>
        ...
        <td><a name="alb_subnet_ids" href="#alb_subnet_ids" className="snap-top"><code>alb_subnet_ids</code></a></td>
        <td>The IDs of the subnets in which to deploy the ALB that runs in front of Jenkins. Must be subnets in var.vpc_id.</td>
    </tr><tr>
        <td><a name="allow_incoming_http_from_cidr_blocks" href="#allow_incoming_http_from_cidr_blocks" className="snap-top"><code>allow_incoming_http_from_cidr_blocks</code></a></td>
        <td>The IP address ranges in CIDR format from which to allow incoming HTTP requests to Jenkins.</td>
    </tr><tr>
        <td><a name="allow_incoming_http_from_security_group_ids" href="#allow_incoming_http_from_security_group_ids" className="snap-top"><code>allow_incoming_http_from_security_group_ids</code></a></td>
        ...
        <td><a name="backup_job_metric_name" href="#backup_job_metric_name" className="snap-top"><code>backup_job_metric_name</code></a></td>
        ...
        <td><a name="backup_job_metric_namespace" href="#backup_job_metric_namespace" className="snap-top"><code>backup_job_metric_namespace</code></a></td>
        ...
        <td><a name="backup_job_schedule_expression" href="#backup_job_schedule_expression" className="snap-top"><code>backup_job_schedule_expression</code></a></td>
        ...
        <td><a name="backup_using_dlm" href="#backup_using_dlm" className="snap-top"><code>backup_using_dlm</code></a></td>
        <td>Set to true to backup the Jenkins Server using AWS Data Lifecycle Management Policies.</td>
    </tr><tr>
        <td><a name="backup_using_lambda" href="#backup_using_lambda" className="snap-top"><code>backup_using_lambda</code></a></td>
        <td>Set to true to backup the Jenkins Server using a Scheduled Lambda Function.</td>
    </tr><tr>
        <td><a name="build_permission_actions" href="#build_permission_actions" className="snap-top"><code>build_permission_actions</code></a></td>
        ...
        <td><a name="dlm_backup_job_schedule_interval" href="#dlm_backup_job_schedule_interval" className="snap-top"><code>dlm_backup_job_schedule_interval</code></a></td>
        <td>How often this lifecycle policy should be evaluated, in hours.</td>
    </tr><tr>
        <td><a name="dlm_backup_job_schedule_name" href="#dlm_backup_job_schedule_name" className="snap-top"><code>dlm_backup_job_schedule_name</code></a></td>
        <td>The name of the data lifecyle management schedule</td>
    </tr><tr>
        <td><a name="dlm_backup_job_schedule_number_of_snapshots_to_retain" href="#dlm_backup_job_schedule_number_of_snapshots_to_retain" className="snap-top"><code>dlm_backup_job_schedule_number_of_snapshots_to_retain</code></a></td>
        <td>How many snapshots to keep. Must be an integer between 1 and 1000.</td>
    </tr><tr>
        <td><a name="dlm_backup_job_schedule_times" href="#dlm_backup_job_schedule_times" className="snap-top"><code>dlm_backup_job_schedule_times</code></a></td>
        ...
        <td><a name="ebs_kms_key_arn" href="#ebs_kms_key_arn" className="snap-top"><code>ebs_kms_key_arn</code></a></td>
        ...
        <td><a name="ebs_kms_key_arn_is_alias" href="#ebs_kms_key_arn_is_alias" className="snap-top"><code>ebs_kms_key_arn_is_alias</code></a></td>
        ...
        <td><a name="external_account_auto_deploy_iam_role_arns" href="#external_account_auto_deploy_iam_role_arns" className="snap-top"><code>external_account_auto_deploy_iam_role_arns</code></a></td>
        ...
        <td><a name="jenkins_device_name" href="#jenkins_device_name" className="snap-top"><code>jenkins_device_name</code></a></td>
        <td>The OS device name where the Jenkins EBS volume should be attached</td>
    </tr><tr>
        <td><a name="jenkins_mount_point" href="#jenkins_mount_point" className="snap-top"><code>jenkins_mount_point</code></a></td>
        <td>The OS path where the Jenkins EBS volume should be mounted</td>
    </tr><tr>
        <td><a name="jenkins_subnet_id" href="#jenkins_subnet_id" className="snap-top"><code>jenkins_subnet_id</code></a></td>
        <td>The ID of the subnet in which to deploy Jenkins. Must be a subnet in var.vpc_id.</td>
    </tr><tr>
        <td><a name="jenkins_user" href="#jenkins_user" className="snap-top"><code>jenkins_user</code></a></td>
        <td>The OS user that should be used to run Jenkins</td>
    </tr><tr>
        <td><a name="jenkins_volume_encrypted" href="#jenkins_volume_encrypted" className="snap-top"><code>jenkins_volume_encrypted</code></a></td>
        <td>Set to true to encrypt the Jenkins EBS volume.</td>
    </tr><tr>
        <td><a name="jenkins_volume_size" href="#jenkins_volume_size" className="snap-top"><code>jenkins_volume_size</code></a></td>
        <td>The amount of disk space, in GB, to allocate for the EBS volume used by the Jenkins server.</td>
    </tr><tr>
        <td><a name="jenkins_volume_type" href="#jenkins_volume_type" className="snap-top"><code>jenkins_volume_type</code></a></td>
        ...
        <td><a name="root_block_device_volume_type" href="#root_block_device_volume_type" className="snap-top"><code>root_block_device_volume_type</code></a></td>
        ...
        <td><a name="skip_health_check" href="#skip_health_check" className="snap-top"><code>skip_health_check</code></a></td>
  ...
  <TabItem value="outputs" label="Outputs">
    <table>
        ...
        <td><a name="alb_dns_name" href="#alb_dns_name" className="snap-top"><code>alb_dns_name</code></a></td>
        ...
        <td><a name="alb_http_listener_arns" href="#alb_http_listener_arns" className="snap-top"><code>alb_http_listener_arns</code></a></td>
        <td>The ARNs of just the HTTP ALB listeners of the ALB deployed in front of Jenkins</td>
    </tr><tr>
        <td><a name="alb_https_listener_acm_cert_arns" href="#alb_https_listener_acm_cert_arns" className="snap-top"><code>alb_https_listener_acm_cert_arns</code></a></td>
        <td>The ARNs of just the HTTPS ALB listeners that usse ACM certs of the ALB deployed in front of Jenkins</td>
    </tr><tr>
        <td><a name="alb_https_listener_non_acm_cert_arns" href="#alb_https_listener_non_acm_cert_arns" className="snap-top"><code>alb_https_listener_non_acm_cert_arns</code></a></td>
        <td>The ARNs of just the HTTPS ALB listeners that use non-ACM certs of the ALB deployed in front of Jenkins</td>
    </tr><tr>
        <td><a name="alb_listener_arns" href="#alb_listener_arns" className="snap-top"><code>alb_listener_arns</code></a></td>
        ...
        <td><a name="backup_lambda_function_arn" href="#backup_lambda_function_arn" className="snap-top"><code>backup_lambda_function_arn</code></a></td>
        <td></td>
    </tr><tr>
        <td><a name="backup_lambda_function_name" href="#backup_lambda_function_name" className="snap-top"><code>backup_lambda_function_name</code></a></td>
        <td></td>
    </tr><tr>
        <td><a name="jenkins_asg_name" href="#jenkins_asg_name" className="snap-top"><code>jenkins_asg_name</code></a></td>
        <td>The name of the Auto Scaling Group in which Jenkins is running</td>
    </tr><tr>
        <td><a name="jenkins_domain_name" href="#jenkins_domain_name" className="snap-top"><code>jenkins_domain_name</code></a></td>
        <td>The public domain name configured for Jenkins</td>
    </tr><tr>
        <td><a name="jenkins_ebs_volume_id" href="#jenkins_ebs_volume_id" className="snap-top"><code>jenkins_ebs_volume_id</code></a></td>
        <td>The ID of the EBS Volume that will store the JENKINS_HOME directory</td>
    </tr><tr>
        <td><a name="jenkins_iam_role_arn" href="#jenkins_iam_role_arn" className="snap-top"><code>jenkins_iam_role_arn</code></a></td>
        <td>The ARN of the IAM role attached to the Jenkins EC2 Instance</td>
    </tr><tr>
        <td><a name="jenkins_iam_role_id" href="#jenkins_iam_role_id" className="snap-top"><code>jenkins_iam_role_id</code></a></td>
        <td>The ID of the IAM role attached to the Jenkins EC2 Instance</td>
    </tr><tr>
        <td><a name="jenkins_security_group_id" href="#jenkins_security_group_id" className="snap-top"><code>jenkins_security_group_id</code></a></td>
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"Service Catalog Reference","hash":"2c7a0d35317d11228b260bc5b890180f"}
##DOCS-SOURCER-END -->
