...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/ebeneliason-patch-2/modules/landingzone/account-baseline-security" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[the iam-users-and-groups module](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/ebeneliason-patch-2/modules/landingzone/iam-users-and-groups) for managing IAM Users and Groups.
...
*   [How to use multi-region services](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/ebeneliason-patch-2/modules/landingzone/account-baseline-root/core-concepts.md#how-to-use-multi-region-services)
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"service-catalog-api","hash":"adfb08fa79e5e704e4630bcb873131dd"}
##DOCS-SOURCER-END -->
