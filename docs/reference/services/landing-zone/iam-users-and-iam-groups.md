...
<VersionBadge version="0.111.3" lastModifiedVersion="0.98.0"/>

# IAM Users and IAM Groups

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.111.3/modules/landingzone/iam-users-and-groups" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "iam_users_and_groups" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/landingzone/iam-users-and-groups?ref=v0.111.3"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.111.3/modules/landingzone/iam-users-and-groups/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.111.3/modules/landingzone/iam-users-and-groups/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.111.3/modules/landingzone/iam-users-and-groups/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "6597e902785213b190e194ca91049357"
}
##DOCS-SOURCER-END -->
