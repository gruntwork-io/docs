...
<VersionBadge version="0.118.6" lastModifiedVersion="0.98.0"/>

# IAM Users and IAM Groups

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.6/modules/landingzone/iam-users-and-groups" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "iam_users_and_groups" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/landingzone/iam-users-and-groups?ref=v0.118.6"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.6/modules/landingzone/iam-users-and-groups/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.6/modules/landingzone/iam-users-and-groups/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.6/modules/landingzone/iam-users-and-groups/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "9997c7489702ae6d772b8efc678f44bb"
}
##DOCS-SOURCER-END -->
