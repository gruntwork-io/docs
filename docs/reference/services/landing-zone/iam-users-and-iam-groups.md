...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.108.4/modules/landingzone/iam-users-and-groups" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "iam_users_and_groups" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/landingzone/iam-users-and-groups?ref=v0.108.4"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.108.4/modules/landingzone/iam-users-and-groups/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.108.4/modules/landingzone/iam-users-and-groups/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.108.4/modules/landingzone/iam-users-and-groups/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "6f1e3b0d4e9bc4da4610efefb7259d34"
}
##DOCS-SOURCER-END -->
