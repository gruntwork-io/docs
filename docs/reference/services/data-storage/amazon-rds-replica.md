...
<VersionBadge version="0.112.10" lastModifiedVersion="0.105.0"/>

# RDS Read Replicas Module

This module creates a read replica (read-only copy) of a DB instance.

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.10/modules/data-stores/rds-replica" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "rds_replica" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/data-stores/rds-replica?ref=v0.112.10"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.10/modules/data-stores/rds-replica/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.10/modules/data-stores/rds-replica/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.10/modules/data-stores/rds-replica/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "1bb1c889b3a785dda277c3f7d7caecac"
}
##DOCS-SOURCER-END -->
