...
<VersionBadge version="2.13.0" lastModifiedVersion="2.13.0"/>

# Amazon Relational Database Service

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.13.0/modules/data-stores/rds" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
*   [How do I pass database configuration securely?](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.13.0/modules/data-stores/rds/core-concepts.md#how-do-i-pass-database-configuration-securely)
...
module "rds" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/data-stores/rds?ref=v2.13.0"
  ...
  # Enable RDS Blue/Green deployments to minimize downtime when changes are
  # applied to the DB instance (e.g. engine version upgrades or parameter group
  # changes). Only supported for MySQL, MariaDB, and PostgreSQL, and requires
  # backups to be enabled. See
...
If set to true, create an AWS Backup vault and plan to periodically back up the RDS DB. Supports optional cross-account copy via <a href="#backup_destination_vault_arn"><code>backup_destination_vault_arn</code></a>.
...
Enable RDS Blue/Green deployments to minimize downtime when changes are applied to the DB instance (e.g. engine version upgrades or parameter group changes). Only supported for MySQL, MariaDB, and PostgreSQL, and requires backups to be enabled. See https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/blue-green-deployments-overview.html for more details.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.13.0/modules/data-stores/rds/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.13.0/modules/data-stores/rds/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.13.0/modules/data-stores/rds/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "021b64423e9542b98f3c34de289fc758"
}
##DOCS-SOURCER-END -->
