...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/ebeneliason-patch-2/modules/services/eks-cluster" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
To add and manage additional worker groups, refer to the [eks-workers module](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/ebeneliason-patch-2/modules/services/eks-workers).
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"service-catalog-api","hash":"c75ed23e5f978d63b0c778f51c29c972"}
##DOCS-SOURCER-END -->
