...
module "ecs_fargate_cluster" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/ecs-fargate-cluster?ref=v0.115.2"
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "84f8f95194de341c84420fbe0a20a4f9"
}
##DOCS-SOURCER-END -->
