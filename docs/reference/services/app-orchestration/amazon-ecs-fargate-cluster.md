...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/ebeneliason-patch-2/modules/services/ecs-fargate-cluster" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
cluster on top of an Auto Scaling Group, refer to the [ecs-cluster module](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/ebeneliason-patch-2/modules/services/ecs-cluster). Refer to the section
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"service-catalog-api","hash":"c7410a5c3fcdd7c61f6d7026c6e39517"}
##DOCS-SOURCER-END -->
