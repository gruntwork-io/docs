...
[EC2 vs Fargate Launch Types](https://github.com/gruntwork-io/terraform-aws-ecs/blob/main/core-concepts.md#ec2-vs-fargate-launch-types)
...
*   Runs the
    ...
    [cloudwatch-agent](https://github.com/gruntwork-io/terraform-aws-monitoring/tree/main/modules/agents/cloudwatch-agent).
...
*   Emits custom metrics that are not available by default in CloudWatch, including memory and disk usage. This is
    ...
    module](https://github.com/gruntwork-io/terraform-aws-monitoring/tree/main/modules/agents/cloudwatch-agent).

*   Runs the [syslog module](https://github.com/gruntwork-io/terraform-aws-monitoring/tree/main/modules/logs/syslog)
    to automatically rotate and rate limit syslog so that your instances don’t run out of disk space from large volumes.

*   Runs the [ssh-grunt module](https://github.com/gruntwork-io/terraform-aws-security/tree/main/modules/ssh-grunt) so
...
*   Runs the [auto-update module](https://github.com/gruntwork-io/terraform-aws-security/tree/main/modules/auto-update)
...
[ecs-cluster documentation](https://github.com/gruntwork-io/terraform-aws-ecs/tree/main/modules/ecs-cluster) in the
...
[cloudwatch-agent documentation](https://github.com/gruntwork-io/terraform-aws-monitoring/tree/main/modules/agents/cloudwatch-agent).
...
[How do you configure cluster autoscaling?](https://github.com/gruntwork-io/terraform-aws-ecs/tree/main/modules/ecs-cluster#how-do-you-configure-cluster-autoscaling)
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "26380e332c34b4dcc60815caec04d81a"
}
##DOCS-SOURCER-END -->
