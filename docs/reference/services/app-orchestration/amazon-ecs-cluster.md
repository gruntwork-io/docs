...
module "ecs_cluster" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/ecs-cluster?ref=v0.118.2"
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "6e3306628d4743ae18609ba06f59452f"
}
##DOCS-SOURCER-END -->
