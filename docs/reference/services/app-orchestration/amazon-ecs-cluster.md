...
module "ecs_cluster" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/ecs-cluster?ref=v0.114.2"
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "a9db9ca7e260b5158d31950f91090e0a"
}
##DOCS-SOURCER-END -->
