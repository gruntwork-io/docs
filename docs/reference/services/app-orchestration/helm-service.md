...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.6/modules/services/helm-service" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "helm_service" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/helm-service?ref=v0.109.6"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.6/modules/services/helm-service/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.6/modules/services/helm-service/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.6/modules/services/helm-service/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "de4b84e80277a2d7880625539f776f43"
}
##DOCS-SOURCER-END -->
