...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.11.1/modules/services/helm-service" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "helm_service" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/helm-service?ref=v2.11.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.11.1/modules/services/helm-service/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.11.1/modules/services/helm-service/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v2.11.1/modules/services/helm-service/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "4cf212834d0c4893a03c6c216e61f6ed"
}
##DOCS-SOURCER-END -->
