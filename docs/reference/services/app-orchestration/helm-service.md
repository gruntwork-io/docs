...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.119.0/modules/services/helm-service" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "helm_service" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/helm-service?ref=v0.119.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.119.0/modules/services/helm-service/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.119.0/modules/services/helm-service/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.119.0/modules/services/helm-service/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "9c2d199125825a425d9c83946ea8e9b4"
}
##DOCS-SOURCER-END -->
