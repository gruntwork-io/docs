...
<VersionBadge version="0.104.15" lastModifiedVersion="0.104.8"/>

# Lambda

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.104.15/modules/services/lambda" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "lambda" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/lambda?ref=v0.104.15"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.104.15/modules/services/lambda/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.104.15/modules/services/lambda/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.104.15/modules/services/lambda/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "924544a09e8db55fd89096ccf5f6d0c6"
}
##DOCS-SOURCER-END -->
