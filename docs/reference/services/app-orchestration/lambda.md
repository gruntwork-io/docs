...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.3.0/modules/services/lambda" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "lambda" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/lambda?ref=v1.3.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.3.0/modules/services/lambda/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.3.0/modules/services/lambda/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.3.0/modules/services/lambda/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "0564ca2c8252f89241328623abe4398c"
}
##DOCS-SOURCER-END -->
