...
<VersionBadge version="0.146.3" lastModifiedVersion="0.142.1"/>

# Amazon ECS Service

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.146.3/modules/services/ecs-service" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
*   [modules](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.146.3/modules): the main implementation code for this repo, broken down into multiple standalone, orthogonal
    submodules.
...
module "ecs_service" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/ecs-service?ref=v0.146.3"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.146.3/modules/services/ecs-service/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.146.3/modules/services/ecs-service/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.146.3/modules/services/ecs-service/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "24d51e10e6cefc1e0a264ac61bf08ed0"
}
##DOCS-SOURCER-END -->
