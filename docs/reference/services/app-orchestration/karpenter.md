...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.2.0/modules/services/eks-karpenter" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "eks_karpenter" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/eks-karpenter?ref=v1.2.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.2.0/modules/services/eks-karpenter/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.2.0/modules/services/eks-karpenter/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.2.0/modules/services/eks-karpenter/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "8525879cc48f5a2763a9d8b53c0750c7"
}
##DOCS-SOURCER-END -->
