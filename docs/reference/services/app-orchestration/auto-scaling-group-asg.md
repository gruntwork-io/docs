...
<VersionBadge version="1.0.0" lastModifiedVersion="0.129.0"/>

# Auto Scaling Group

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.0.0/modules/services/asg-service" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
*   [User Data](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.0.0/modules/services/asg-service/core-concepts.md)
...
module "asg_service" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/asg-service?ref=v1.0.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.0.0/modules/services/asg-service/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.0.0/modules/services/asg-service/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v1.0.0/modules/services/asg-service/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "ffe1b091255040fe1fc679d1de6ef30b"
}
##DOCS-SOURCER-END -->
