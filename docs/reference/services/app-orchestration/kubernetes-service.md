...
<VersionBadge version="0.118.7" lastModifiedVersion="0.118.7"/>

# Kubernetes Service

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.7/modules/services/k8s-service" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "k_8_s_service" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/k8s-service?ref=v0.118.7"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.7/modules/services/k8s-service/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.7/modules/services/k8s-service/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.118.7/modules/services/k8s-service/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "d7ba01eb0a78ee789c2988703329f642"
}
##DOCS-SOURCER-END -->
