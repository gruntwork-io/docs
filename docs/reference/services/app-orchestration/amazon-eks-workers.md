...
<Tabs>
  <TabItem value="inputs" label="Inputs" default>
    <table>
        ...
        <td>A list of additional security group IDs to be attached on worker groups.</td>
    </tr><tr>
        ...
        <td><a name="asg_custom_iam_role_name" href="#asg_custom_iam_role_name" className="snap-top"><code>asg_custom_iam_role_name</code></a></td>
        ...
        <td><a name="asg_iam_role_already_exists" href="#asg_iam_role_already_exists" className="snap-top"><code>asg_iam_role_already_exists</code></a></td>
        ...
        <td><a name="asg_iam_role_arn" href="#asg_iam_role_arn" className="snap-top"><code>asg_iam_role_arn</code></a></td>
        ...
        <td><a name="custom_egress_security_group_rules" href="#custom_egress_security_group_rules" className="snap-top"><code>custom_egress_security_group_rules</code></a></td>
        <td>A map of unique identifiers to egress security group rules to attach to the worker groups.</td>
    </tr><tr>
        <td><a name="custom_ingress_security_group_rules" href="#custom_ingress_security_group_rules" className="snap-top"><code>custom_ingress_security_group_rules</code></a></td>
        ...
        <td><a name="managed_node_group_custom_iam_role_name" href="#managed_node_group_custom_iam_role_name" className="snap-top"><code>managed_node_group_custom_iam_role_name</code></a></td>
        ...
        <td><a name="managed_node_group_iam_role_already_exists" href="#managed_node_group_iam_role_already_exists" className="snap-top"><code>managed_node_group_iam_role_already_exists</code></a></td>
        ...
        <td><a name="managed_node_group_iam_role_arn" href="#managed_node_group_iam_role_arn" className="snap-top"><code>managed_node_group_iam_role_arn</code></a></td>
        ...
        <td><a name="node_group_names" href="#node_group_names" className="snap-top"><code>node_group_names</code></a></td>
        ...
        <td><a name="worker_k8s_role_mapping_name" href="#worker_k8s_role_mapping_name" className="snap-top"><code>worker_k8s_role_mapping_name</code></a></td>
  ...
  <TabItem value="outputs" label="Outputs">
    <table>
        ...
        <tbody>
            <tr>
        <td><a name="managed_node_group_arns" href="#managed_node_group_arns" className="snap-top"><code>managed_node_group_arns</code></a></td>
        ...
        <td><a name="managed_node_group_worker_security_group_ids" href="#managed_node_group_worker_security_group_ids" className="snap-top"><code>managed_node_group_worker_security_group_ids</code></a></td>
        ...
        <td><a name="metric_widget_managed_node_group_worker_cpu_usage" href="#metric_widget_managed_node_group_worker_cpu_usage" className="snap-top"><code>metric_widget_managed_node_group_worker_cpu_usage</code></a></td>
        <td>A CloudWatch Dashboard widget that graphs CPU usage (percentage) of the Managed Node Group EKS workers.</td>
    </tr><tr>
        <td><a name="metric_widget_managed_node_group_worker_disk_usage" href="#metric_widget_managed_node_group_worker_disk_usage" className="snap-top"><code>metric_widget_managed_node_group_worker_disk_usage</code></a></td>
        <td>A CloudWatch Dashboard widget that graphs disk usage (percentage) of the Managed Node Group EKS workers.</td>
    </tr><tr>
        <td><a name="metric_widget_managed_node_group_worker_memory_usage" href="#metric_widget_managed_node_group_worker_memory_usage" className="snap-top"><code>metric_widget_managed_node_group_worker_memory_usage</code></a></td>
        <td>A CloudWatch Dashboard widget that graphs memory usage (percentage) of the Managed Node Group EKS workers.</td>
    </tr><tr>
        <td><a name="metric_widget_self_managed_worker_cpu_usage" href="#metric_widget_self_managed_worker_cpu_usage" className="snap-top"><code>metric_widget_self_managed_worker_cpu_usage</code></a></td>
        <td>A CloudWatch Dashboard widget that graphs CPU usage (percentage) of the self-managed EKS workers.</td>
    </tr><tr>
        <td><a name="metric_widget_self_managed_worker_disk_usage" href="#metric_widget_self_managed_worker_disk_usage" className="snap-top"><code>metric_widget_self_managed_worker_disk_usage</code></a></td>
        <td>A CloudWatch Dashboard widget that graphs disk usage (percentage) of the self-managed EKS workers.</td>
    </tr><tr>
        <td><a name="metric_widget_self_managed_worker_memory_usage" href="#metric_widget_self_managed_worker_memory_usage" className="snap-top"><code>metric_widget_self_managed_worker_memory_usage</code></a></td>
        ...
        <td><a name="worker_asg_names" href="#worker_asg_names" className="snap-top"><code>worker_asg_names</code></a></td>
...
<!-- ##DOCS-SOURCER-START
{"sourcePlugin":"Service Catalog Reference","hash":"c81479e2bdd08f738901f83fedc97e4b"}
##DOCS-SOURCER-END -->
