...
<VersionBadge version="0.109.5" lastModifiedVersion="0.101.0"/>

# Public Static Website

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/modules/services/public-static-website" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
hosted in a Public Hosted Zone in Route 53. You may provide a `hosted_zone_id` in [variables](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/modules/services/public-static-website/variables.tf),
...
*   [Quick Start](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/modules/services/public-static-website/core-concepts.md#quick-start)
...
*   [How to configure HTTPS (SSL) or a CDN?](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/modules/services/public-static-website/core-concepts.md#how-to-configure-https-ssl-or-a-cdn)
...
*   [examples/for-learning-and-testing folder](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/examples/for-learning-and-testing): The
...
*   [examples/for-production folder](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/examples/for-learning-and-testing/services/public-static-website/example-website):
...
module "public_static_website" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/services/public-static-website?ref=v0.109.5"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/modules/services/public-static-website/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/modules/services/public-static-website/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.5/modules/services/public-static-website/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "6598743663989616768affa828afcd9c"
}
##DOCS-SOURCER-END -->
