...
<VersionBadge version="0.90.5" lastModifiedVersion="0.90.4"/>

# Public Static Website

[![Docs](https://img.shields.io/badge/docs-docs.gruntwork.io-informational)](https://docs.gruntwork.io/reference/services/app-orchestration/public-static-website)

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules/services/public-static-website" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
hosted in a Public Hosted Zone in Route 53. You may provide a `hosted_zone_id` in [variables](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules/services/public-static-website/variables.tf),
...
*   [Quick Start](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules/services/public-static-website/core-concepts.md#quick-start)
...
*   [How to configure HTTPS (SSL) or a CDN?](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules/services/public-static-website/core-concepts.md#how-to-configure-https-ssl-or-a-cdn)
...
*   [modules](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules): the main implementation code for this repo, broken down into multiple standalone, orthogonal submodules.
*   [examples](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/examples): This folder contains working examples of how to use the submodules.
*   [test](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/test): Automated tests for the modules and examples.
...
*   [examples/for-production folder](https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/examples/for-learning-and-testing/services/public-static-website/example-website):
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules%2Fservices%2Fpublic-static-website%2FREADME.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules%2Fservices%2Fpublic-static-website%2Fvariables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.90.5/modules%2Fservices%2Fpublic-static-website%2Foutputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "99fa59e77f2c45280ab878ea69a87c5c"
}
##DOCS-SOURCER-END -->
