...
<VersionBadge version="0.112.16" lastModifiedVersion="0.104.4"/>

# Bastion Host

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.16/modules/mgmt/bastion-host" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "bastion_host" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/mgmt/bastion-host?ref=v0.112.16"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.16/modules/mgmt/bastion-host/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.16/modules/mgmt/bastion-host/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.16/modules/mgmt/bastion-host/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "6db172260a57a4e9d65395a2f04ee34a"
}
##DOCS-SOURCER-END -->
