...
<VersionBadge version="0.112.5" lastModifiedVersion="0.104.4"/>

# Bastion Host

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.5/modules/mgmt/bastion-host" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "bastion_host" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/mgmt/bastion-host?ref=v0.112.5"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.5/modules/mgmt/bastion-host/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.5/modules/mgmt/bastion-host/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.112.5/modules/mgmt/bastion-host/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "5f3a26716846106be95f53a0a77d0a98"
}
##DOCS-SOURCER-END -->
