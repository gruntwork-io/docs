...
<VersionBadge version="0.109.1" lastModifiedVersion="0.107.5"/>

# OpenVPN Server

<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.1/modules/mgmt/openvpn-server" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "openvpn_server" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/mgmt/openvpn-server?ref=v0.109.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.1/modules/mgmt/openvpn-server/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.1/modules/mgmt/openvpn-server/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.109.1/modules/mgmt/openvpn-server/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "205f7a6d629615469bed67dca8b9123f"
}
##DOCS-SOURCER-END -->
