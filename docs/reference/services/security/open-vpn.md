...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.129.0/modules/mgmt/openvpn-server" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "openvpn_server" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/mgmt/openvpn-server?ref=v0.129.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.129.0/modules/mgmt/openvpn-server/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.129.0/modules/mgmt/openvpn-server/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.129.0/modules/mgmt/openvpn-server/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "8487c2f035e940f2cd86c54db262f5f2"
}
##DOCS-SOURCER-END -->
