...
<a href="https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.127.8/modules/mgmt/openvpn-server" className="link-button" title="View the source code for this service in GitHub.">View Source</a>
...
module "openvpn_server" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-service-catalog.git//modules/mgmt/openvpn-server?ref=v0.127.8"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.127.8/modules/mgmt/openvpn-server/README.md",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.127.8/modules/mgmt/openvpn-server/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-service-catalog/tree/v0.127.8/modules/mgmt/openvpn-server/outputs.tf"
  ],
  "sourcePlugin": "service-catalog-api",
  "hash": "02a17c71b99823d8682f8fc7ae4d885f"
}
##DOCS-SOURCER-END -->
