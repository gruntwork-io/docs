...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.11/modules/lambda-http-api-gateway" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[api-gateway-proxy](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.11/modules/api-gateway-proxy) module.
...
*   [examples/lambda-http-api-gateway](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.11/examples/lambda-http-api-gateway): This example contains sample code that uses
...
module "lambda_http_api_gateway" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-lambda.git//modules/lambda-http-api-gateway?ref=v0.21.11"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.11/modules/lambda-http-api-gateway/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.11/modules/lambda-http-api-gateway/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.11/modules/lambda-http-api-gateway/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "9b82f9392ab883563149f20d92071335"
}
##DOCS-SOURCER-END -->
