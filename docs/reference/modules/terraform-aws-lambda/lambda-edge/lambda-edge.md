...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.14/modules/lambda-edge" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Instructions on how to do this can be found at the   [`lambda-edge-multi-region-log-groups` module](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.14/modules/lambda-edge-multi-region-log-groups). To see which regions are receiving traffic, you can find graphs of metrics for the
...
module "lambda_edge" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-lambda.git//modules/lambda-edge?ref=v0.21.14"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.14/modules/lambda-edge/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.14/modules/lambda-edge/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.14/modules/lambda-edge/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "6b1fcd942a6612808f1ccf444e3032db"
}
##DOCS-SOURCER-END -->
