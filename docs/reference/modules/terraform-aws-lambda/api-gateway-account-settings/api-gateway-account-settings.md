...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/api-gateway-account-settings" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [examples](https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/examples) for sample code that demonstrates how to use this module.
...
module "api_gateway_account_settings" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-lambda.git//modules/api-gateway-account-settings?ref=v0.21.10"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/api-gateway-account-settings/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/api-gateway-account-settings/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/api-gateway-account-settings/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "0f37b10eaaedce13593fa23beb1d7aa0"
}
##DOCS-SOURCER-END -->
