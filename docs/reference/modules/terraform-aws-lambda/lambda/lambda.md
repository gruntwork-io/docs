...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/lambda" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [lambda-vpc example](https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/examples/lambda-vpc) for working sample code. Make sure to note the Known Issues
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/lambda/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/lambda/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/update-nodejs/modules/lambda/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "24765a1ac3b576966b4f2b783bed1cdc"
}
##DOCS-SOURCER-END -->
