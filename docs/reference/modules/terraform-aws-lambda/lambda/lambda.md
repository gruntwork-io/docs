...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.13/modules/lambda" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [lambda-vpc example](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.13/examples/lambda-vpc) for working sample code. Make sure to note the Known Issues
...
module "lambda" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-lambda.git//modules/lambda?ref=v0.21.13"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.13/modules/lambda/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.13/modules/lambda/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.13/modules/lambda/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "feaded4425868f836ec8f5a33018f90e"
}
##DOCS-SOURCER-END -->
