...
<VersionBadge repoTitle="AWS Lambda" version="1.0.0" lastModifiedVersion="0.20.3"/>
...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/run-lambda-entrypoint" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
refer to the [lambda](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/lambda) module.
...
*   [examples/lambda-docker](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/examples/lambda-docker): This example contains a sample `Dockerfile` that uses this
...
Refer to the [secret-reflector-go](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/examples/lambda-docker/secret-reflector-go) example for an example of how to set
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/run-lambda-entrypoint/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/run-lambda-entrypoint/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/run-lambda-entrypoint/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "62fb7b845abe0885461b4e5c2a1ceec0"
}
##DOCS-SOURCER-END -->
