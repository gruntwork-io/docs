...
<VersionBadge repoTitle="AWS Lambda" version="0.21.12" lastModifiedVersion="0.20.3"/>
...
refer to the [lambda](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.12/modules/lambda) module.
...
*   [examples/lambda-docker](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.12/examples/lambda-docker): This example contains a sample `Dockerfile` that uses this
...
Refer to the [secret-reflector-go](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.12/examples/lambda-docker/secret-reflector-go) example for an example of how to set
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.12/modules/run-lambda-entrypoint/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.12/modules/run-lambda-entrypoint/variables.tf",
