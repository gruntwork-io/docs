...
<VersionBadge repoTitle="AWS Lambda" version="0.21.10" lastModifiedVersion="0.20.3"/>
...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/fix%2F200-update-nodejs-runtimes/modules/run-lambda-entrypoint" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
refer to the [lambda](https://github.com/gruntwork-io/terraform-aws-lambda/tree/fix%2F200-update-nodejs-runtimes/modules/lambda) module.
...
*   [examples/lambda-docker](https://github.com/gruntwork-io/terraform-aws-lambda/tree/fix%2F200-update-nodejs-runtimes/examples/lambda-docker): This example contains a sample `Dockerfile` that uses this
...
Refer to the [secret-reflector-go](https://github.com/gruntwork-io/terraform-aws-lambda/tree/fix%2F200-update-nodejs-runtimes/examples/lambda-docker/secret-reflector-go) example for an example of how to set
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/fix%2F200-update-nodejs-runtimes/modules/run-lambda-entrypoint/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/fix%2F200-update-nodejs-runtimes/modules/run-lambda-entrypoint/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/fix%2F200-update-nodejs-runtimes/modules/run-lambda-entrypoint/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c7a0e0bdb05b685354b2a8bb173cb080"
}
##DOCS-SOURCER-END -->
