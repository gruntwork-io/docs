...
<VersionBadge repoTitle="AWS Lambda" version="0.21.9" lastModifiedVersion="0.20.3"/>
...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.9/modules/run-lambda-entrypoint" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
refer to the [lambda](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.9/modules/lambda) module.
...
*   [examples/lambda-docker](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.9/examples/lambda-docker): This example contains a sample `Dockerfile` that uses this
...
Refer to the [secret-reflector-go](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.9/examples/lambda-docker/secret-reflector-go) example for an example of how to set
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.9/modules/run-lambda-entrypoint/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.9/modules/run-lambda-entrypoint/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v0.21.9/modules/run-lambda-entrypoint/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c71fb3338763447de3864f66da9036d4"
}
##DOCS-SOURCER-END -->
