...
<VersionBadge repoTitle="AWS Lambda" version="1.4.0" lastModifiedVersion="1.3.1"/>
...
<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.4.0/modules/run-lambda-entrypoint" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
refer to the [lambda](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.4.0/modules/lambda) module.
...
*   [examples/lambda-docker](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.4.0/examples/lambda-docker): This example contains a sample `Dockerfile` that uses this
...
Refer to the [secret-reflector-go](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.4.0/examples/lambda-docker/secret-reflector-go) example for an example of how to set
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.4.0/modules/run-lambda-entrypoint/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.4.0/modules/run-lambda-entrypoint/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.4.0/modules/run-lambda-entrypoint/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "1bd9f6835045923e59543c9a2c027ce7"
}
##DOCS-SOURCER-END -->
