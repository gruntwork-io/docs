...
<VersionBadge repoTitle="AWS Lambda" version="1.0.0" lastModifiedVersion="0.22.0"/>

# API Gateway Proxy Module

<a href="https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[lambda-http-api-gateway](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/lambda-http-api-gateway) module.
...
*   [What is API Gateway?](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/core-concepts.md#what-is-api-gateway)
*   [What is the difference between the different endpoint
    types?](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/core-concepts.md#what-is-the-difference-between-the-different-endpoint-types)
...
*   [modules](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules): the main implementation code for this repo, broken down into multiple standalone, orthogonal submodules.
*   [examples](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/examples): This folder contains working examples of how to use the submodules.
*   [test](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/test): Automated tests for the modules and examples.

## Deploy

If you just want to try this repo out for experimenting and learning, check out the following resources:

*   [examples folder](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/examples): The `examples` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
...
*   [How do I expose AWS Lambda functions using API
    Gateway?](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/core-concepts.md#how-do-i-expose-aws-lambda-functions-using-api-gateway)
*   [Can I expose additional lambda functions in a decentralized
    manner?](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/core-concepts.md#can-i-expose-additional-lambda-functions-in-a-decentralized-manner)
*   [How do I pass in the us_east\_1 aws provider?](https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/core-concepts.md#how-do-i-pass-in-the-us_east\_1-aws-provider)
...
module "api_gateway_proxy" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-lambda.git//modules/api-gateway-proxy?ref=v1.0.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-lambda/tree/v1.0.0/modules/api-gateway-proxy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "37617c7670d7a9aaff8742893ce090a9"
}
##DOCS-SOURCER-END -->
