...
<VersionBadge repoTitle="Open VPN Package Infrastructure Package" version="1.0.0" lastModifiedVersion="0.26.2"/>

# Backup PKI Assets Module

<a href="https://github.com/gruntwork-io/terraform-aws-openvpn/tree/v1.0.0/modules/backup-openvpn-pki" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
the [install-openvpn](https://github.com/gruntwork-io/terraform-aws-openvpn/tree/v1.0.0/modules/install-openvpn) module.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-openvpn/tree/v1.0.0/modules/backup-openvpn-pki/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-openvpn/tree/v1.0.0/modules/backup-openvpn-pki/variables.tf",
