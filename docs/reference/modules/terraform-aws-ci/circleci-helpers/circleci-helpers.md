...
<a href="https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/circleci-helpers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/circleci-helpers/variables.tf",
