...
<a href="https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/build-helpers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
with the scripts in the [terraform-helpers module](https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/terraform-helpers) to automatically deploy the new AMI:
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/build-helpers/variables.tf",
