...
<VersionBadge repoTitle="CI Modules" version="0.52.15" lastModifiedVersion="0.50.11"/>

# Build Helpers

<a href="https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.15/modules/build-helpers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
with the scripts in the [terraform-helpers module](https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.15/modules/terraform-helpers) to automatically deploy the new AMI:
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.15/modules/build-helpers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.15/modules/build-helpers/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.15/modules/build-helpers/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "fd3121b3538b4f3e8034b7ee1b0a431e"
}
##DOCS-SOURCER-END -->
