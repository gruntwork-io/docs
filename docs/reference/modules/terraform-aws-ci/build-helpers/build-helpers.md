...
<VersionBadge repoTitle="CI Modules" version="0.52.3" lastModifiedVersion="0.50.11"/>

# Build Helpers

<a href="https://github.com/gruntwork-io/terraform-aws-ci/tree/remove-zack-from-codeowners/modules/build-helpers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
with the scripts in the [terraform-helpers module](https://github.com/gruntwork-io/terraform-aws-ci/tree/remove-zack-from-codeowners/modules/terraform-helpers) to automatically deploy the new AMI:
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/remove-zack-from-codeowners/modules/build-helpers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/remove-zack-from-codeowners/modules/build-helpers/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/remove-zack-from-codeowners/modules/build-helpers/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "ea48fb0453959617910bdb778b4fd4ab"
}
##DOCS-SOURCER-END -->
