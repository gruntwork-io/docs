...
<VersionBadge repoTitle="CI Modules" version="1.3.0" lastModifiedVersion="0.52.4"/>

# Terraform Helpers

<a href="https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/terraform-helpers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Note that `terraform-update-variable` depends on the [git-helpers module](https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/git-helpers) being installed!
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/terraform-helpers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v1.3.0/modules/terraform-helpers/variables.tf",
