...
<VersionBadge repoTitle="CI Modules" version="0.52.12" lastModifiedVersion="0.52.10"/>

# Jenkins server

<a href="https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.12/modules/jenkins-server" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   See [vars.tf](https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.12/modules/jenkins-server/vars.tf) for all parameters you can configure on this module.

## Jenkins AMI

See the [install-jenkins module](https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.12/modules/install-jenkins) for a way to create an AMI with Jenkins installed and a
script you can run in User Data to start Jenkins while the server is booting.

## Backing up Jenkins

See the [ec2-backup module](https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.12/modules/ec2-backup) for an automatic way to take scheduled backups of Jenkins and its EBS
volume.
...
module "jenkins_server" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-ci.git//modules/jenkins-server?ref=v0.52.12"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.12/modules/jenkins-server/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ci/tree/v0.52.12/modules/jenkins-server/variables.tf",
