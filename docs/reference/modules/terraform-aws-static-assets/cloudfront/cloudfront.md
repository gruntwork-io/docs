...
<VersionBadge repoTitle="Static Assets Modules" version="1.1.1" lastModifiedVersion="1.1.1"/>

# CloudFront Module

<a href="https://github.com/gruntwork-io/terraform-aws-static-assets/tree/v1.1.1/modules/cloudfront" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-static-assets/releases/tag/v1.1.1" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
*   See the [cloudfront-custom-origin](https://github.com/gruntwork-io/terraform-aws-static-assets/tree/v1.1.1/examples/cloudfront) example for working sample code.
*   Check out [vars.tf](https://github.com/gruntwork-io/terraform-aws-static-assets/tree/v1.1.1/modules/cloudfront/vars.tf) for all parameters you can set for this module.
...
module "cloudfront" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-static-assets.git//modules/cloudfront?ref=v1.1.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-static-assets/tree/v1.1.1/modules/cloudfront/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-static-assets/tree/v1.1.1/modules/cloudfront/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-static-assets/tree/v1.1.1/modules/cloudfront/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "3ac49fee678dcb94a56eeb8521c15d7d"
}
##DOCS-SOURCER-END -->
