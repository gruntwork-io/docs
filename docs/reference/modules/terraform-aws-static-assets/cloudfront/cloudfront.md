...
*   See the [cloudfront-custom-origin](https://github.com/gruntwork-io/terraform-aws-static-assets/tree/v0.20.2/examples/cloudfront) example for working sample code.
