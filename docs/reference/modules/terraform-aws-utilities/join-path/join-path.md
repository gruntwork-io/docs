...
<a href="https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.1/modules/join-path" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
See the [join-path example](https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.1/examples/join-path) for working sample code.
...
module "join_path" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-utilities.git//modules/join-path?ref=v0.10.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.1/modules/join-path/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.1/modules/join-path/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.1/modules/join-path/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "0c25266d7c6e44a1e0ab1c87f49d81bd"
}
##DOCS-SOURCER-END -->
