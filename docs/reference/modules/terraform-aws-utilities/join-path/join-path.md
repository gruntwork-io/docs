...
<a href="https://github.com/gruntwork-io/terraform-aws-utilities/tree/v1.0.0/modules/join-path" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
See the [join-path example](https://github.com/gruntwork-io/terraform-aws-utilities/tree/v1.0.0/examples/join-path) for working sample code.
...
module "join_path" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-utilities.git//modules/join-path?ref=v1.0.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v1.0.0/modules/join-path/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v1.0.0/modules/join-path/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v1.0.0/modules/join-path/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "154b4e90f28204e4c92ff8ba881afef2"
}
##DOCS-SOURCER-END -->
