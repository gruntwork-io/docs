...
<a href="https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/join-path" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
See the [join-path example](https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/examples/join-path) for working sample code.
...
module "join_path" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-utilities.git//modules/join-path?ref=v0.10.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/join-path/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/join-path/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/join-path/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "ec9db92e150df9e5dfbd21b66661b841"
}
##DOCS-SOURCER-END -->
