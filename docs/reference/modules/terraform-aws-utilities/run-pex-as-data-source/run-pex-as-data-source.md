...
<a href="https://github.com/gruntwork-io/terraform-aws-utilities/tree/remove-zack-from-codeowners/modules/run-pex-as-data-source" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
This module uses the data source approach (you can see the [run-pex-as-resource module](https://github.com/gruntwork-io/terraform-aws-utilities/tree/remove-zack-from-codeowners/modules/run-pex-as-resource) for
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/remove-zack-from-codeowners/modules/run-pex-as-data-source/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/remove-zack-from-codeowners/modules/run-pex-as-data-source/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/remove-zack-from-codeowners/modules/run-pex-as-data-source/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "2d8158ee8dcea43d83236f72c59b454a"
}
##DOCS-SOURCER-END -->
