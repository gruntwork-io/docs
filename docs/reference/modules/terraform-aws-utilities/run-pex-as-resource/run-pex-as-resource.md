...
<a href="https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/run-pex-as-resource" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
This module uses the Provisioner approach (you can see the [run-pex-as-data-source module](https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/run-pex-as-data-source)
...
module "run_pex_as_resource" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-utilities.git//modules/run-pex-as-resource?ref=v0.10.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/run-pex-as-resource/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/run-pex-as-resource/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-utilities/tree/v0.10.2/modules/run-pex-as-resource/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "7ab2bbc2def9219cf5735ed302888536"
}
##DOCS-SOURCER-END -->
