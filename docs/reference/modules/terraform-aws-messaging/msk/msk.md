...
<a href="https://github.com/gruntwork-io/terraform-aws-messaging/tree/v0.12.4/modules/msk" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   [IAM access control](https://docs.aws.amazon.com/msk/latest/developerguide/iam-access-control.html)
    ...
    to the [msk-with-iam-auth example module](https://github.com/gruntwork-io/terraform-aws-messaging/tree/v0.12.4/examples/msk-with-iam-auth).
...
module "msk" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-messaging.git//modules/msk?ref=v0.12.4"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-messaging/tree/v0.12.4/modules/msk/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-messaging/tree/v0.12.4/modules/msk/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-messaging/tree/v0.12.4/modules/msk/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "5d6a0bb9af135dd63e51c9886d1e18fb"
}
##DOCS-SOURCER-END -->
