...
module "amazon_mq" {
  ...
  # List of CIDR blocks to allow outbound traffic from the broker security
  # group. Defaults to unrestricted.
  allowed_outbound_cidr_blocks = ["0.0.0.0/0"]

  # List of security group IDs allowed to connect to the broker.
  allowed_security_groups = []

  # Map of application users for the broker, keyed by username. Each user must
  # specify password, and optionally console_access and groups (ActiveMQ only).
  application_users = {}
  ...
  # Defines whether this broker is a part of a data replication pair. Valid
  # values are CRDR (Cross-Region Data Replication) and NONE.
...
<HclListItem name="allowed_outbound_cidr_blocks" requirement="optional" type="list(string)">
<HclListItemDescription>

List of CIDR blocks to allow outbound traffic from the broker security group. Defaults to unrestricted.
...
<HclListItem name="application_users" requirement="optional" type="map(object(…))">
<HclListItemDescription>

Map of application users for the broker, keyed by username. Each user must specify password, and optionally console_access and groups (ActiveMQ only).
...
<HclListItem name="data_replication_mode" requirement="optional" type="string">
<HclListItemDescription>

Defines whether this broker is a part of a data replication pair. Valid values are CRDR (Cross-Region Data Replication) and NONE.
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "31c17e345b829a8775872fb64459d3e4"
}
##DOCS-SOURCER-END -->
