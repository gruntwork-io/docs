...
<a href="https://github.com/gruntwork-io/terraform-aws-asg/tree/etiene-194-root-volume/modules/server-group" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [server-group examples](https://github.com/gruntwork-io/terraform-aws-asg/tree/etiene-194-root-volume/examples/server-group) for sample code that demonstrates how to use this module.
...
[asg-rolling-deploy module](https://github.com/gruntwork-io/terraform-aws-asg/tree/etiene-194-root-volume/modules/asg-rolling-deploy)), attaching ENIs and EBS Volumes to servers in an ASG is very
tricky:
...
[rolling_deployment.py](https://github.com/gruntwork-io/terraform-aws-asg/tree/etiene-194-root-volume/modules/server-group/rolling-deploy/rolling_deployment.py) which runs in a [local-exec
...
module "server_group" {
  ...
  # or io1. Please note that when using EBS optimized AMIs, the root volume name
  # name is determined by the AMI, and if var.block_device_name does not match
  # the AMI's device name, AWS will create another volume instead of applying
  # this configuration to the root volume.
...
The type of the root volume of each server. Must be one of: standard, gp2, or io1. Please note that when using EBS optimized AMIs, the root volume name name is determined by the AMI, and if <a href="#block_device_name"><code>block_device_name</code></a> does not match the AMI's device name, AWS will create another volume instead of applying this configuration to the root volume.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/etiene-194-root-volume/modules/server-group/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/etiene-194-root-volume/modules/server-group/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/etiene-194-root-volume/modules/server-group/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "a7c1d08f7f520c8a8024c3684bba778a"
}
##DOCS-SOURCER-END -->
