...
Check out the [server-group examples](https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.2/examples/server-group) for sample code that demonstrates how to use this module.
...
[asg-rolling-deploy module](https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.2/modules/asg-rolling-deploy)), attaching ENIs and EBS Volumes to servers in an ASG is very
tricky:
...
[rolling_deployment.py](https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.2/modules/server-group/rolling-deploy/rolling_deployment.py) which runs in a [local-exec
...
module "server_group" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-asg.git//modules/server-group?ref=v1.0.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.2/modules/server-group/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.2/modules/server-group/variables.tf",
