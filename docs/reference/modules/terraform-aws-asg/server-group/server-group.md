...
<VersionBadge repoTitle="Auto Scaling Group Modules" version="0.21.10" lastModifiedVersion="0.21.10"/>

# Server Group Module

<a href="https://github.com/gruntwork-io/terraform-aws-asg/tree/v0.21.10/modules/server-group" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-asg/releases/tag/v0.21.10" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
Check out the [server-group examples](https://github.com/gruntwork-io/terraform-aws-asg/tree/v0.21.10/examples/server-group) for sample code that demonstrates how to use this module.
...
[asg-rolling-deploy module](https://github.com/gruntwork-io/terraform-aws-asg/tree/v0.21.10/modules/asg-rolling-deploy)), attaching ENIs and EBS Volumes to servers in an ASG is very
tricky:
...
[rolling_deployment.py](https://github.com/gruntwork-io/terraform-aws-asg/tree/v0.21.10/modules/server-group/rolling-deploy/rolling_deployment.py) which runs in a [local-exec
...
module "server_group" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-asg.git//modules/server-group?ref=v0.21.10"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v0.21.10/modules/server-group/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v0.21.10/modules/server-group/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v0.21.10/modules/server-group/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "10813d7ca3e8f8416f6dadb684a22beb"
}
##DOCS-SOURCER-END -->
