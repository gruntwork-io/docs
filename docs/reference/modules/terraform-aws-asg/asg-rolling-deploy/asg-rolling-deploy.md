...
<VersionBadge repoTitle="Auto Scaling Group Modules" version="1.0.1" lastModifiedVersion="1.0.1"/>

# Auto Scaling Group with Rolling Deployment Module

<a href="https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.1/modules/asg-rolling-deploy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-asg/releases/tag/v1.0.1" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
[get-desired-capacity.py](https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.1/modules/asg-rolling-deploy/describe-autoscaling-group/get-desired-capacity.py) to fetch the latest value of the
...
module "asg_rolling_deploy" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-asg.git//modules/asg-rolling-deploy?ref=v1.0.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.1/modules/asg-rolling-deploy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.1/modules/asg-rolling-deploy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-asg/tree/v1.0.1/modules/asg-rolling-deploy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "ff12a590448923b277a11b2eb4ed4196"
}
##DOCS-SOURCER-END -->
