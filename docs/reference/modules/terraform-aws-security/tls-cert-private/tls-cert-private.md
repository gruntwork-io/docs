...
<VersionBadge repoTitle="Security Modules" version="0.73.1" lastModifiedVersion="0.47.0"/>

# Generate a TLS/SSL Certificate for a Private Service

<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v0.73.1/modules/tls-cert-private" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
To see documentation on the arguments in `docker-compose.yml`, see the [main.sh](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.73.1/modules/tls-cert-private/scripts/main.sh) file.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.73.1/modules/tls-cert-private/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.73.1/modules/tls-cert-private/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.73.1/modules/tls-cert-private/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "9004eb636914fe8e3ea15d9a15abb626"
}
##DOCS-SOURCER-END -->
