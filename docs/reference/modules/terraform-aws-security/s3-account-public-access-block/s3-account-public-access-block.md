...
<VersionBadge repoTitle="Security Modules" version="1.5.1" lastModifiedVersion="1.4.0"/>

# S3 Account Public Access Block

<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.1/modules/s3-account-public-access-block" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   [examples/s3-account-public-access-block](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.1/examples/s3-account-public-access-block): A sample configuration optimized for learning, experimenting, and testing (but not production usage).
...
module "s_3_account_public_access_block" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/s3-account-public-access-block?ref=v1.5.1"
...
<HclListItem name="ignore_public_acls">
<HclListItemDescription>
...
<HclListItem name="restrict_public_buckets">
<HclListItemDescription>
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.1/modules/s3-account-public-access-block/readme.adoc",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.1/modules/s3-account-public-access-block/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.1/modules/s3-account-public-access-block/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "43510dfb2e3a865014bd723e4f76b105"
}
##DOCS-SOURCER-END -->
