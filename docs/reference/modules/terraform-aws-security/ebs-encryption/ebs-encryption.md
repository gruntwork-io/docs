...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.0/modules/ebs-encryption" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
This module is not meant to be used directly. Instead, it's used under the hood in the [account-baseline-\*](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.0/modules)
...
module "ebs_encryption" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/ebs-encryption?ref=v1.7.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.0/modules/ebs-encryption/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.0/modules/ebs-encryption/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.0/modules/ebs-encryption/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "01aaa86e33076f432bce01c4cb30ae3a"
}
##DOCS-SOURCER-END -->
