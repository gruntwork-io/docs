...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.1/modules/ebs-encryption" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
This module is not meant to be used directly. Instead, it's used under the hood in the [account-baseline-\*](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.1/modules)
...
module "ebs_encryption" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/ebs-encryption?ref=v1.7.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.1/modules/ebs-encryption/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.1/modules/ebs-encryption/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.7.1/modules/ebs-encryption/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "fd95931fef7604cc0325d8d30c7dec75"
}
##DOCS-SOURCER-END -->
