...
<VersionBadge repoTitle="Security Modules" version="0.69.4" lastModifiedVersion="0.69.4"/>

# AWS KMS Customer Master Keys (CMK)

<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key-multi-region" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-security/releases/tag/v0.69.4" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
*   [What is KMS?](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key/README.md#what-is-kms)

*   [What is the difference between creating one key in all regions and creating a single all-region key?](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key-multi-region/core-concepts.md#what-is-the-difference-between-creating-one-key-in-all-regions-and-creating-a-single-all-region-key)

*   [What is a Customer Master Key?](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key/README.md#what-is-a-customer-master-key)
...
*   [How to use a multi-region module](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/codegen/core-concepts.md#how-to-use-a-multi-region-module)
...
*   [examples folder](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/examples): The `examples` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).

## Manage

*   [Differences between CMK Administrators vs. CMK Users](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key/README.md#cmk-administrators-vs-cmk-users)

*   [Differences between managing access control with KMS key policies vs. IAM policies](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key/README.md#managing-a-keys-permissions-with-the-key-policy-vs-iam-policies)

*   [What is the difference between KMS Grants and Key Policies?](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-grant-multi-region/core-concepts.md#what-is-the-difference-between-kms-grants-and-key-policies)

*   [How do I use KMS Grants to share encrypted AMIs across accounts?](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-grant-multi-region/core-concepts.md#how-do-i-use-kms-grants-to-share-encrypted-amis-across-accounts)
...
module "kms_master_key_multi_region" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/kms-master-key-multi-region?ref=v0.69.4"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key-multi-region/readme.adoc",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key-multi-region/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.69.4/modules/kms-master-key-multi-region/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "9e48782b2fdd7d65e81cee838d90540d"
}
##DOCS-SOURCER-END -->
