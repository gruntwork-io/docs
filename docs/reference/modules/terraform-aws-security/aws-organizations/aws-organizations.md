...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-organizations" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   [What is a Root account?](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-organizations/core-concepts.md#what-is-a-root-account)

*   [What are Organization Accounts?](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-organizations/core-concepts.md#what-are-organization-accounts)

*   [What resources does this module create?](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-organizations/core-concepts.md#what-resources-does-this-module-create)
...
*   [examples/aws-organizations](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/examples/aws-organizations): The `examples/aws-organizations` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
...
*   [How do I provision new accounts?](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-organizations/core-concepts.md#how-do-i-provision-new-accounts)

*   [How do I remove accounts?](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-organizations/core-concepts.md#how-do-i-remove-accounts)
...
module "aws_organizations" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/aws-organizations?ref=v1.5.0"
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-organizations/variables.tf",
