...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v0.70.1/modules/iam-groups" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   **use-existing-iam-roles:** IAM Users in this group can pass *existing* IAM Roles to AWS resources to which they have
    ...
    [the three levels of IAM permissions](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.70.1/modules/iam-policies#the-three-levels-of-iam-permissions) for more information.
...
This module does not create any IAM Users, nor assign any existing IAM Users to IAM Groups. You can use the [iam-users module](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.70.1/modules/iam-users) to create users.
...
module "iam_groups" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/iam-groups?ref=v0.70.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.70.1/modules/iam-groups/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.70.1/modules/iam-groups/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.70.1/modules/iam-groups/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "463d55e322e7b808090750e258aa3e20"
}
##DOCS-SOURCER-END -->
