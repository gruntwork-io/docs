...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v1.0.2/modules/iam-groups" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   **use-existing-iam-roles:** IAM Users in this group can pass *existing* IAM Roles to AWS resources to which they have
    ...
    [the three levels of IAM permissions](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.0.2/modules/iam-policies#the-three-levels-of-iam-permissions) for more information.
...
This module does not create any IAM Users, nor assign any existing IAM Users to IAM Groups. You can use the [iam-users module](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.0.2/modules/iam-users) to create users.
...
module "iam_groups" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/iam-groups?ref=v1.0.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.0.2/modules/iam-groups/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.0.2/modules/iam-groups/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.0.2/modules/iam-groups/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "eb948edf66ea098a35d1fe3b6bd11092"
}
##DOCS-SOURCER-END -->
