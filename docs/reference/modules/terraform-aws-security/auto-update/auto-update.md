...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v0.74.1/modules/auto-update" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   Supports Amazon Linux 2 via [yum-cron](http://man7.org/linux/man-pages/man8/yum-cron.8.html).
...
*   [How to install Auto Update](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.74.1/modules/auto-update/core-concepts.md#installation)
...
*   [auto-update example](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.74.1/examples/auto-update): The `examples/auto-update` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.74.1/modules/auto-update/readme.adoc",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.74.1/modules/auto-update/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.74.1/modules/auto-update/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "93db7fadc8202ead9eb1ccce1979a472"
}
##DOCS-SOURCER-END -->
