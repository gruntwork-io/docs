...
<VersionBadge repoTitle="Security Modules" version="1.5.0" lastModifiedVersion="0.65.9"/>

# AWS Auth Helper

<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-auth" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-auth/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.5.0/modules/aws-auth/variables.tf",
