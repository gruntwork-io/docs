...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v0.71.1/modules/iam-policies" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[iam-groups](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.71.1/modules/iam-groups) and [cross-account-iam-roles](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.71.1/modules/cross-account-iam-roles) modules for examples.
...
*   **ssh_grunt_permissions**: provides the permissions [ssh-grunt](https://github.com/gruntwork-io/terraform-aws-security/tree/v0.71.1/modules/ssh-grunt) needs to validate SSH keys with
    IAM.
...
module "iam_policies" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/iam-policies?ref=v0.71.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.71.1/modules/iam-policies/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.71.1/modules/iam-policies/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v0.71.1/modules/iam-policies/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c5f546153e6ab23142b4f3b09abb7d39"
}
##DOCS-SOURCER-END -->
