...
<a href="https://github.com/gruntwork-io/terraform-aws-security/tree/v1.4.1/modules/gitlab-pipelines-iam-role" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
You can use the [OpenID Connect Provider for GitLab Pipelines](https://github.com/gruntwork-io/terraform-aws-security/tree/v1.4.1/modules/gitlab-pipelines-openid-connect-provider/README.md) module in the IAM role creation process like so:
...
module "gitlab_pipelines_iam_role" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-security.git//modules/gitlab-pipelines-iam-role?ref=v1.4.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.4.1/modules/gitlab-pipelines-iam-role/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.4.1/modules/gitlab-pipelines-iam-role/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-security/tree/v1.4.1/modules/gitlab-pipelines-iam-role/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "e5b9cadb67784bb2adde44158d48acc9"
}
##DOCS-SOURCER-END -->
