...
<VersionBadge repoTitle="Amazon ECS" version="1.1.0" />

# ECS Task Definition Module

<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-task-definition" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-ecs/releases?q=ecs-task-definition" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
See [variables.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-task-definition/variables.tf) for all the variables you can set on this module.

## What does this module output?

See [outputs.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-task-definition/outputs.tf) for all the outputs this module provides.
...
See [variables.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-task-definition/variables.tf) for specific variable definitions.
...
module "ecs_task_definition" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-ecs.git//modules/ecs-task-definition?ref=v1.1.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-task-definition/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-task-definition/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-task-definition/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "9664ec76057ab430eeb4ba92f78f8641"
}
##DOCS-SOURCER-END -->
