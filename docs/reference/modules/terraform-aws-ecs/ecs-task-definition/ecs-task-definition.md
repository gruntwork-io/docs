...
<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.1/modules/ecs-task-definition" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
See [variables.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.1/modules/ecs-task-definition/variables.tf) for all the variables you can set on this module.

## What does this module output?

See [outputs.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.1/modules/ecs-task-definition/outputs.tf) for all the outputs this module provides.
...
See [variables.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.1/modules/ecs-task-definition/variables.tf) for specific variable definitions.
...
module "ecs_task_definition" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-ecs.git//modules/ecs-task-definition?ref=v1.4.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.1/modules/ecs-task-definition/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.1/modules/ecs-task-definition/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.1/modules/ecs-task-definition/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c82d93cfebe909352af3aafd4d332b68"
}
##DOCS-SOURCER-END -->
