...
<VersionBadge repoTitle="Amazon ECS" version="0.35.14" lastModifiedVersion="0.35.12"/>

# ECS Daemon Service Module

<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.14/modules/ecs-daemon-service" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
To use ECS, you first deploy one or more EC2 Instances into a "cluster". See the [ecs-cluster module](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.14/modules/ecs-cluster)
...
module "ecs_daemon_service" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-ecs.git//modules/ecs-daemon-service?ref=v0.35.14"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.14/modules/ecs-daemon-service/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.14/modules/ecs-daemon-service/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.14/modules/ecs-daemon-service/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "b329262f7c47b5ecb174f17951ff997c"
}
##DOCS-SOURCER-END -->
