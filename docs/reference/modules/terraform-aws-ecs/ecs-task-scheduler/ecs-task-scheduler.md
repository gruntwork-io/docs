...
<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/firelens/modules/ecs-task-scheduler" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
See [variables.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/firelens/modules/ecs-task-scheduler/variables.tf) for specific variable definitions.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/firelens/modules/ecs-task-scheduler/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/firelens/modules/ecs-task-scheduler/variables.tf",
