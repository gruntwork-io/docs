...
<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.2/modules/ecs-task-scheduler" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
See [variables.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.2/modules/ecs-task-scheduler/variables.tf) for specific variable definitions.
...
module "ecs_task_scheduler" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-ecs.git//modules/ecs-task-scheduler?ref=v1.4.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.2/modules/ecs-task-scheduler/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.4.2/modules/ecs-task-scheduler/variables.tf",
