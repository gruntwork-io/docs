...
<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-cluster" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Docker containers and services (see the [ecs-service module](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-service/README.adoc)).
...
See the [service module](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-service/README.adoc).
...
To deploy an update to an ECS Service, see the [ecs-service module](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-service). To deploy an update to the
...
4.  Run the script:
    ...
    If you have your output variables configured as shown in [outputs.tf](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/examples/docker-service-with-elb/outputs.tf)
    of the [docker-service-with-elb example](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/examples/docker-service-with-elb), you can use the `terraform output`
...
[roll-out-ecs-cluster-update.py](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-cluster/roll-out-ecs-cluster-update.py)
...
module "ecs_cluster" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-ecs.git//modules/ecs-cluster?ref=v0.35.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-cluster/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-cluster/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.35.2/modules/ecs-cluster/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "441d0302f4d9db3ca2a232c634eab244"
}
##DOCS-SOURCER-END -->
