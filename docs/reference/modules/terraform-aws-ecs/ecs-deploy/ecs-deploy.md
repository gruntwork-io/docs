...
<VersionBadge repoTitle="Amazon ECS" version="1.1.0" lastModifiedVersion="0.37.0"/>

# ECS Deployment Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-deploy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [deploy-ecs-task example](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/examples/deploy-ecs-task) for working sample code of both of the above.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-deploy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-deploy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v1.1.0/modules/ecs-deploy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "7a91a2ae4b3602f4ad32d9b6ea77b794"
}
##DOCS-SOURCER-END -->
