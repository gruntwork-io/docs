...
<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/feature%2F392-ecs-service-change-default-launch-type-behavior/modules/ecs-deploy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [deploy-ecs-task example](https://github.com/gruntwork-io/terraform-aws-ecs/tree/feature%2F392-ecs-service-change-default-launch-type-behavior/examples/deploy-ecs-task) for working sample code of both of the above.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/feature%2F392-ecs-service-change-default-launch-type-behavior/modules/ecs-deploy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/feature%2F392-ecs-service-change-default-launch-type-behavior/modules/ecs-deploy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/feature%2F392-ecs-service-change-default-launch-type-behavior/modules/ecs-deploy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "e8e0281359826f85c354ef75851050ca"
}
##DOCS-SOURCER-END -->
