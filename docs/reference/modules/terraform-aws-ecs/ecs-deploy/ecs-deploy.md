...
<VersionBadge repoTitle="Amazon ECS" version="0.38.0" lastModifiedVersion="0.37.0"/>

# ECS Deployment Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.0/modules/ecs-deploy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [deploy-ecs-task example](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.0/examples/deploy-ecs-task) for working sample code of both of the above.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.0/modules/ecs-deploy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.0/modules/ecs-deploy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.0/modules/ecs-deploy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "56241c530016ae9fc34a5e58d83176b5"
}
##DOCS-SOURCER-END -->
