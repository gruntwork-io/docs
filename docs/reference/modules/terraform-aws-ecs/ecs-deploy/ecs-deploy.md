...
<VersionBadge repoTitle="Amazon ECS" version="0.36.0" lastModifiedVersion="0.35.3"/>

# ECS Deployment Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.36.0/modules/ecs-deploy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [deploy-ecs-task example](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.36.0/examples/deploy-ecs-task) for working sample code of both of the above.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.36.0/modules/ecs-deploy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.36.0/modules/ecs-deploy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.36.0/modules/ecs-deploy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "d85ab299f9d35f23f7bfdfce03009a1e"
}
##DOCS-SOURCER-END -->
