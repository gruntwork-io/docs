...
<VersionBadge repoTitle="Amazon ECS" version="0.38.4" lastModifiedVersion="0.37.0"/>

# ECS Deployment Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.4/modules/ecs-deploy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [deploy-ecs-task example](https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.4/examples/deploy-ecs-task) for working sample code of both of the above.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.4/modules/ecs-deploy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.4/modules/ecs-deploy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-ecs/tree/v0.38.4/modules/ecs-deploy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "4f0f0d9f54e680e4d80530a8ebb8a734"
}
##DOCS-SOURCER-END -->
