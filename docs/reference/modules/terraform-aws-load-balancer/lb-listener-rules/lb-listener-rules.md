...
<VersionBadge repoTitle="Load Balancer Modules" version="0.30.2" lastModifiedVersion="0.29.24"/>

# Load Balancer Listener Rules

<a href="https://github.com/gruntwork-io/terraform-aws-load-balancer/tree/v0.30.2/modules/lb-listener-rules" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "lb_listener_rules" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-load-balancer.git//modules/lb-listener-rules?ref=v0.30.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-load-balancer/tree/v0.30.2/modules/lb-listener-rules/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-load-balancer/tree/v0.30.2/modules/lb-listener-rules/variables.tf",
