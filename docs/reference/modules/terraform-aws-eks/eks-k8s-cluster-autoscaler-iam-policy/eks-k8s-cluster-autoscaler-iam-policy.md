...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.0/modules/eks-k8s-cluster-autoscaler-iam-policy" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
See [the eks-k8s-cluster-autoscaler module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.0/modules/eks-k8s-cluster-autoscaler) for a module that deploys the Cluster
...
eks-cluster-workers module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.0/modules/eks-cluster-workers/README.md#how-do-you-add-additional-iam-policies).
...
module "eks_k_8_s_cluster_autoscaler_iam_policy" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-cluster-autoscaler-iam-policy?ref=v1.0.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.0/modules/eks-k8s-cluster-autoscaler-iam-policy/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.0/modules/eks-k8s-cluster-autoscaler-iam-policy/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.0/modules/eks-k8s-cluster-autoscaler-iam-policy/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c62658d77f279cccfa9c33ccccc024e5"
}
##DOCS-SOURCER-END -->
