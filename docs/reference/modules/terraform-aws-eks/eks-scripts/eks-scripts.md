...
<VersionBadge repoTitle="Amazon EKS" version="0.67.3" lastModifiedVersion="0.55.2"/>

# EKS Scripts Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.3/modules/eks-scripts" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[examples/eks-cluster-with-supporting-services/packer/build.json](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.3/examples/eks-cluster-with-supporting-services/packer/build.json).
...
using the [eks-cluster-workers module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.3/modules/eks-cluster-workers), this is automatically attached to the worker IAM role.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.3/modules/eks-scripts/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.3/modules/eks-scripts/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.3/modules/eks-scripts/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "a121b264a8373804617038353c98cae6"
}
##DOCS-SOURCER-END -->
