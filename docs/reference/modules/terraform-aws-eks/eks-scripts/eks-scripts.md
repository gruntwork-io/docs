...
<VersionBadge repoTitle="Amazon EKS" version="0.65.6" lastModifiedVersion="0.55.2"/>

# EKS Scripts Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.6/modules/eks-scripts" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[examples/eks-cluster-with-supporting-services/packer/build.json](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.6/examples/eks-cluster-with-supporting-services/packer/build.json).
...
using the [eks-cluster-workers module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.6/modules/eks-cluster-workers), this is automatically attached to the worker IAM role.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.6/modules/eks-scripts/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.6/modules/eks-scripts/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.6/modules/eks-scripts/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "87677bf57be6006f9f5bb7851b9908f2"
}
##DOCS-SOURCER-END -->
