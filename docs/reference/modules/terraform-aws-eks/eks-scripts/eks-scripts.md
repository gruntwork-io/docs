...
<VersionBadge repoTitle="Amazon EKS" version="5.1.0" lastModifiedVersion="3.2.0"/>

# EKS Scripts Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v5.1.0/modules/eks-scripts" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[examples/eks-cluster-with-supporting-services/packer/build.json](https://github.com/gruntwork-io/terraform-aws-eks/tree/v5.1.0/examples/eks-cluster-with-supporting-services/packer/build.json).
...
using the [eks-cluster-workers module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v5.1.0/modules/eks-cluster-workers), this is automatically attached to the worker IAM role.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v5.1.0/modules/eks-scripts/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v5.1.0/modules/eks-scripts/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v5.1.0/modules/eks-scripts/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "45fe69fecaed4abcbb1d11ac53de6fa0"
}
##DOCS-SOURCER-END -->
