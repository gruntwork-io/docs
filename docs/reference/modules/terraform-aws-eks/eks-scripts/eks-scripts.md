...
<VersionBadge repoTitle="Amazon EKS" version="1.0.1" lastModifiedVersion="0.73.1"/>

# EKS Scripts Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.1/modules/eks-scripts" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[examples/eks-cluster-with-supporting-services/packer/build.json](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.1/examples/eks-cluster-with-supporting-services/packer/build.json).
...
using the [eks-cluster-workers module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.1/modules/eks-cluster-workers), this is automatically attached to the worker IAM role.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.1/modules/eks-scripts/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.1/modules/eks-scripts/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.1/modules/eks-scripts/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "516e5a4a8e49f7235c76c7c3bb20a902"
}
##DOCS-SOURCER-END -->
