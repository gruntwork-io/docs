...
<VersionBadge repoTitle="Amazon EKS" version="1.0.2" lastModifiedVersion="0.73.1"/>

# EKS Scripts Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-scripts" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[examples/eks-cluster-with-supporting-services/packer/build.json](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/examples/eks-cluster-with-supporting-services/packer/build.json).
...
using the [eks-cluster-workers module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-cluster-workers), this is automatically attached to the worker IAM role.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-scripts/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-scripts/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-scripts/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "eba74e60c169c688d717affba4b014c2"
}
##DOCS-SOURCER-END -->
