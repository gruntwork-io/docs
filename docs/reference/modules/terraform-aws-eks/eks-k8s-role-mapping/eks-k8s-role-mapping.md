...
<VersionBadge repoTitle="Amazon EKS" version="3.1.1" lastModifiedVersion="0.64.3"/>

# EKS K8S Role Mapping Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.1.1/modules/eks-k8s-role-mapping" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
role in a separate module from the EKS cluster), refer to the [eks-aws-auth-merger](https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.1.1/modules/eks-aws-auth-merger).**
...
system](https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.1.1/core-concepts.md#how-do-i-authenticate-kubectl-to-the-eks-cluster), providing the information to Kubernetes to resolve the user to the right RBAC group based on the provided IAM role credentials.
...
module "eks_k_8_s_role_mapping" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-role-mapping?ref=v3.1.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.1.1/modules/eks-k8s-role-mapping/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.1.1/modules/eks-k8s-role-mapping/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.1.1/modules/eks-k8s-role-mapping/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "194da51b03d0368f7f5dfa86396214a2"
}
##DOCS-SOURCER-END -->
