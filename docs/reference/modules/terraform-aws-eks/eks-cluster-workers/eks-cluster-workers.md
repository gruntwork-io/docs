...
<VersionBadge repoTitle="Amazon EKS" version="0.65.3" lastModifiedVersion="0.64.3"/>

# EKS Cluster Workers Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-workers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
topology](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-control-plane/README.md#what-is-an-eks-cluster). You must launch a control plane in order
for the worker nodes to function. See the [eks-cluster-control-plane module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-control-plane) for
...
module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-managed-workers) for a detailed overview of differences with EKS Managed Node Groups.
...
module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-control-plane).

For an example of a user data script, see the [eks-cluster example's user-data.sh
script](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/examples/eks-cluster-with-iam-role-mappings/user-data/user-data.sh).
...
IAM roles to the Pods?](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-control-plane/README.md#how-do-i-associate-iam-roles-to-the-pods) section of the
...
variable to `true` and also deploy the [Kubernetes Cluster Autoscaler module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-k8s-cluster-autoscaler).
...
module "eks_cluster_workers" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-cluster-workers?ref=v0.65.3"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-workers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-workers/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.65.3/modules/eks-cluster-workers/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "ac20f524c3a59ba5c1f8de3f21ee48a6"
}
##DOCS-SOURCER-END -->
