...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-k8s-external-dns" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[ALB Ingress Controller deployed using the eks-alb-ingress-controller module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-alb-ingress-controller)), the
...
eks-k8s-external-dns-iam-policy module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-k8s-external-dns-iam-policy) for more information.
...
module "eks_k_8_s_external_dns" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-external-dns?ref=v0.72.3"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-k8s-external-dns/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-k8s-external-dns/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-k8s-external-dns/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "07082318fb425da470537395a2d4b0ac"
}
##DOCS-SOURCER-END -->
