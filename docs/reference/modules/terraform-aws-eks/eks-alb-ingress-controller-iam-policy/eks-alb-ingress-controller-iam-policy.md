...
module "eks_alb_ingress_controller_iam_policy" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-alb-ingress-controller-iam-policy?ref=v0.57.0"
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "b970f237fb9cc27e1dc6dfc43f91b815"
}
##DOCS-SOURCER-END -->
