...
<VersionBadge repoTitle="Amazon EKS" version="0.75.0" lastModifiedVersion="0.72.3"/>

# EKS K8s Karpenter Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.75.0/modules/eks-k8s-karpenter" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   From [variables.tf](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.75.0/modules/eks-k8s-karpenter/variables.tf) enable `create_karpenter_deprovisioning_queue`t
...
module "eks_k_8_s_karpenter" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-karpenter?ref=v0.75.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.75.0/modules/eks-k8s-karpenter/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.75.0/modules/eks-k8s-karpenter/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.75.0/modules/eks-k8s-karpenter/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "138d5bc954277780fb04aec3ca2b3051"
}
##DOCS-SOURCER-END -->
