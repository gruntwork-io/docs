...
<VersionBadge repoTitle="Amazon EKS" version="0.58.2" lastModifiedVersion="0.58.0"/>

# EKS K8s Karpenter Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.58.2/modules/eks-k8s-karpenter" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-eks/releases/tag/v0.58.0" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
module "eks_k_8_s_karpenter" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-karpenter?ref=v0.58.2"
  ...
  # Conditional flag to create the Karpenter Node IAM Role. If this is set to false,
  # then an existing IAM Role must be provided with the
  ...
  # Service Account. This is required if `create_karpenter_controller_irsa` is set
  # to false.
  ...
  # Optionally provide a name for the Karpenter Node IAM Role. If unset, a name will
  # be generated.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.58.2/modules/eks-k8s-karpenter/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.58.2/modules/eks-k8s-karpenter/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.58.2/modules/eks-k8s-karpenter/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "361b75d07d76ec413135a31654934332"
}
##DOCS-SOURCER-END -->
