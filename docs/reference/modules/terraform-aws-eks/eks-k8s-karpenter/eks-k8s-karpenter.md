...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.69.1/modules/eks-k8s-karpenter" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
This module will create the following core resources, some of which are optional which are noted in the [input variables](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.69.1/modules/eks-k8s-karpenter/variables.tf):
...
*   From [variables.tf](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.69.1/modules/eks-k8s-karpenter/variables.tf) enable `create_karpenter_deprovisioning_queue`t
...
module "eks_k_8_s_karpenter" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-karpenter?ref=v0.69.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.69.1/modules/eks-k8s-karpenter/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.69.1/modules/eks-k8s-karpenter/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.69.1/modules/eks-k8s-karpenter/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "3bd5748c214f191557b7ca26390578b4"
}
##DOCS-SOURCER-END -->
