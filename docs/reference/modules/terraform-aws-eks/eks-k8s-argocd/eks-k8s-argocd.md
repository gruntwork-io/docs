...
<VersionBadge repoTitle="Amazon EKS" version="0.62.0" />

# Gruntwork GitOps "GruntOps"

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.62.0/modules/eks-k8s-argocd" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
The Gruntwork GitOps module is provided as an alternative method for deploying and managing container workloads on EKS. For minimal workloads that are relatively static,
Gruntwork GitOps is provided as a module to deploy [Argo CD](https://argo-cd.readthedocs.io/en/stab) to an EKS cluster. Argo CD is a Cloud Native Computing Foundation project that has reached the Graduated status. It is one of the most active projects in the CNCF and is a very mature product with an extremely large community of contributors.
...
module "eks_k_8_s_argocd" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-argocd?ref=v0.62.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.62.0/modules/eks-k8s-argocd/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.62.0/modules/eks-k8s-argocd/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.62.0/modules/eks-k8s-argocd/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "e022be99dd5bdbb8413829cd29bf2cd9"
}
##DOCS-SOURCER-END -->
