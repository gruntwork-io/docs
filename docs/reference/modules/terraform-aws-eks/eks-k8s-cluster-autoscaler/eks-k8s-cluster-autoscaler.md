...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v4.5.0/modules/eks-k8s-cluster-autoscaler" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
workers](https://github.com/gruntwork-io/terraform-aws-eks/tree/v4.5.0/modules/eks-cluster-workers) module. By default, the ASG is configured to allow zero-downtime
deployments but is not configured to scale automatically. You must launch an [EKS control
plane](https://github.com/gruntwork-io/terraform-aws-eks/tree/v4.5.0/modules/eks-cluster-control-plane) with worker nodes for this module to function.
...
module "eks_k_8_s_cluster_autoscaler" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-k8s-cluster-autoscaler?ref=v4.5.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v4.5.0/modules/eks-k8s-cluster-autoscaler/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v4.5.0/modules/eks-k8s-cluster-autoscaler/variables.tf",
