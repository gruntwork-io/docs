...
<VersionBadge repoTitle="Amazon EKS" version="0.66.1" lastModifiedVersion="0.65.6"/>

# EKS Cluster Control Plane Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-control-plane" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-workers) for managing EKS worker nodes.
...
You can read more about the different components of EKS in [the project README](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/core-concepts.md#what-is-an-eks-cluster).
...
You can use the
[eks-iam-role-assume-role-policy-for-service-account module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-iam-role-assume-role-policy-for-service-account) to
...
*   If you set the input variable `schedule_control_plane_services_on_fargate` on this module, the module will
    ...
    Fargate Profiles.
*   Fargate does not support DaemonSets. This means that you can't rely on the [eks-container-logs](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-container-logs)
...
instances?](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-workers/README.md#how-do-i-roll-out-an-update-to-the-instances) in the `eks-cluster-workers`
module README.
...
module "eks_cluster_control_plane" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-cluster-control-plane?ref=v0.66.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-control-plane/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-control-plane/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-control-plane/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "3f5e4d485e105f74bcb879ca5db9801d"
}
##DOCS-SOURCER-END -->
