...
<VersionBadge repoTitle="Amazon EKS" version="3.4.0" lastModifiedVersion="3.4.0"/>

# EKS Cluster Control Plane Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-cluster-control-plane" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-eks/releases/tag/v3.4.0" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-cluster-workers) for managing EKS worker nodes.
...
You can read more about the different components of EKS in [the project README](https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/core-concepts.md#what-is-an-eks-cluster).
...
You can use the
[eks-iam-role-assume-role-policy-for-service-account module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-iam-role-assume-role-policy-for-service-account) to
...
*   If you set the input variable `schedule_control_plane_services_on_fargate` on this module, the module will
    ...
    Fargate Profiles.
*   Fargate does not support DaemonSets. This means that you can't rely on the [eks-container-logs](https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-container-logs)
...
instances?](https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-cluster-workers/README.md#how-do-i-roll-out-an-update-to-the-instances) in the `eks-cluster-workers`
module README.
...
module "eks_cluster_control_plane" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-cluster-control-plane?ref=v3.4.0"
  ...
  # are true.
  kubergrunt_download_url = "https://github.com/gruntwork-io/kubergrunt/releases/download/v0.18.1/kubergrunt"
...
<HclListItemDefaultValue defaultValue="&quot;https://github.com/gruntwork-io/kubergrunt/releases/download/v0.18.1/kubergrunt&quot;"/>
</HclListItem>
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-cluster-control-plane/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-cluster-control-plane/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v3.4.0/modules/eks-cluster-control-plane/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "19b4d02c1123b17e6c621e313d922193"
}
##DOCS-SOURCER-END -->
