...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-alb-ingress-controller" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
eks-alb-ingress-controller-iam-policy module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-alb-ingress-controller-iam-policy) for more information.
...
module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-k8s-external-dns) for more information on how to setup the tool.
...
module "eks_alb_ingress_controller" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-alb-ingress-controller?ref=v0.72.3"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-alb-ingress-controller/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-alb-ingress-controller/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.72.3/modules/eks-alb-ingress-controller/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c2b155948f1848fd9c0b2c1250cfb071"
}
##DOCS-SOURCER-END -->
