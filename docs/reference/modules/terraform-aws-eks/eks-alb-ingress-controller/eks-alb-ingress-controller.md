...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-alb-ingress-controller" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
eks-alb-ingress-controller-iam-policy module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-alb-ingress-controller-iam-policy) for more information.
...
module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-k8s-external-dns) for more information on how to setup the tool.
...
module "eks_alb_ingress_controller" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-alb-ingress-controller?ref=v1.0.2"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-alb-ingress-controller/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-alb-ingress-controller/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v1.0.2/modules/eks-alb-ingress-controller/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "6c28618da353784225b53cf0ada529de"
}
##DOCS-SOURCER-END -->
