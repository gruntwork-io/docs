...
<VersionBadge repoTitle="Amazon EKS" version="0.67.11" lastModifiedVersion="0.67.9"/>

# EKS Cluster Managed Workers Module

<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.11/modules/eks-cluster-managed-workers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
To enable auto-scaling in response to resource utilization, deploy the [Kubernetes Cluster Autoscaler module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.11/modules/eks-k8s-cluster-autoscaler).
...
module "eks_cluster_managed_workers" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-cluster-managed-workers?ref=v0.67.11"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.11/modules/eks-cluster-managed-workers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.11/modules/eks-cluster-managed-workers/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.67.11/modules/eks-cluster-managed-workers/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "af83d74b23ce73d10459f31b5b8e3966"
}
##DOCS-SOURCER-END -->
