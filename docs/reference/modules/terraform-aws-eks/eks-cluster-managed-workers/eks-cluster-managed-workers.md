...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-managed-workers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
To enable auto-scaling in response to resource utilization, deploy the [Kubernetes Cluster Autoscaler module](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-k8s-cluster-autoscaler).
...
module "eks_cluster_managed_workers" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-cluster-managed-workers?ref=v0.66.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-managed-workers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-managed-workers/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.66.1/modules/eks-cluster-managed-workers/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c69d43490c09a528a3db36f2094a2e62"
}
##DOCS-SOURCER-END -->
