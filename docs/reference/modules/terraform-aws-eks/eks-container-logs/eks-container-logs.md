...
<a href="https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.60.0/modules/eks-container-logs" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Fargate pods, take a look at the [eks-fargate-container-logs](https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.60.0/modules/eks-fargate-container-logs) module.**
...
module "eks_container_logs" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-eks.git//modules/eks-container-logs?ref=v0.60.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.60.0/modules/eks-container-logs/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-eks/tree/v0.60.0/modules/eks-container-logs/variables.tf",
