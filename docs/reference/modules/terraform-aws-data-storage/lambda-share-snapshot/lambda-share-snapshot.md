...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.47.0/modules/lambda-share-snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
are created by the [lambda-create-snapshot module](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.47.0/modules/lambda-create-snapshot), which can be configured to
...
module "lambda_share_snapshot" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/lambda-share-snapshot?ref=v0.47.0"
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.47.0/modules/lambda-share-snapshot/variables.tf",
