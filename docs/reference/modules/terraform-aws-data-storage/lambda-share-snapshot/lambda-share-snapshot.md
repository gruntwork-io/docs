...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.32/modules/lambda-share-snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
are created by the [lambda-create-snapshot module](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.32/modules/lambda-create-snapshot), which can be configured to
...
documentation](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.32/modules/lambda-create-snapshot).
...
module "lambda_share_snapshot" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/lambda-share-snapshot?ref=v0.32"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.32/modules/lambda-share-snapshot/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.32/modules/lambda-share-snapshot/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.32/modules/lambda-share-snapshot/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "0f4b7512a2fe8b1e2e8b9ebc6e6258bf"
}
##DOCS-SOURCER-END -->
