...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-share-snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
are created by the [lambda-create-snapshot module](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot), which can be configured to
...
documentation](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot).
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-share-snapshot/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-share-snapshot/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-share-snapshot/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "c4f4bb199094e51403a7bdf34cd4f4b6"
}
##DOCS-SOURCER-END -->
