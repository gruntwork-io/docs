...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.0/modules/backup-vault" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "backup_vault" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/backup-vault?ref=v0.40.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.0/modules/backup-vault/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.0/modules/backup-vault/variables.tf",
