...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/doc_update/modules/aurora" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
and encryption. For a list of all available variables and their descriptions, see [variables.tf](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/doc_update/modules/aurora/variables.tf).
...
See the example [here](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/doc_update/examples/aurora-with-cross-region-replica) for more details.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/doc_update/modules/aurora/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/doc_update/modules/aurora/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/doc_update/modules/aurora/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "4c603f8fb2160a351c95432af6b7262f"
}
##DOCS-SOURCER-END -->
