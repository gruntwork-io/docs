...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.37.0/modules/aurora" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
and encryption. For a list of all available variables and their descriptions, see [variables.tf](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.37.0/modules/aurora/variables.tf).
...
See the example [here](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.37.0/examples/aurora-with-cross-region-replica) for more details.
...
module "aurora" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/aurora?ref=v0.37.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.37.0/modules/aurora/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.37.0/modules/aurora/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.37.0/modules/aurora/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "63cd982924483f6e0602e00119d04ab7"
}
##DOCS-SOURCER-END -->
