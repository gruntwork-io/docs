...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_cross_region_example/modules/aurora" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
and encryption. For a list of all available variables and their descriptions, see [variables.tf](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_cross_region_example/modules/aurora/variables.tf).
...
See the example [here](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_cross_region_example/examples/aurora-with-cross-region-replica) for more details.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_cross_region_example/modules/aurora/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_cross_region_example/modules/aurora/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_cross_region_example/modules/aurora/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "ccb0072065367f06a21d9e73dc749b53"
}
##DOCS-SOURCER-END -->
