...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_proxy_test/modules/aurora" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
and encryption. For a list of all available variables and their descriptions, see [variables.tf](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_proxy_test/modules/aurora/variables.tf).
...
See the example [here](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_proxy_test/examples/aurora-with-cross-region-replica) for more details.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_proxy_test/modules/aurora/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_proxy_test/modules/aurora/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/rds_proxy_test/modules/aurora/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "aa9be2084601427824454f4aa160b942"
}
##DOCS-SOURCER-END -->
