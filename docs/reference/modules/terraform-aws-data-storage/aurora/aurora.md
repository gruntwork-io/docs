...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.38.0/modules/aurora" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
and encryption. For a list of all available variables and their descriptions, see [variables.tf](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.38.0/modules/aurora/variables.tf).
...
See the example [here](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.38.0/examples/aurora-with-cross-region-replica) for more details.
...
module "aurora" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/aurora?ref=v0.38.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.38.0/modules/aurora/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.38.0/modules/aurora/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.38.0/modules/aurora/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "328a50612e09d46c4b55f311dbb36d7d"
}
##DOCS-SOURCER-END -->
