...
<VersionBadge repoTitle="Data Storage Modules" version="1.2.0" lastModifiedVersion="1.0.0"/>

# Aurora Module

<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.2.0/modules/aurora" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
and encryption. For a list of all available variables and their descriptions, see [variables.tf](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.2.0/modules/aurora/variables.tf).
...
See the example [here](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.2.0/examples/aurora-with-cross-region-replica) for more details.
...
module "aurora" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/aurora?ref=v1.2.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.2.0/modules/aurora/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.2.0/modules/aurora/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.2.0/modules/aurora/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "a29068979502103ef12abfc27b51dc9e"
}
##DOCS-SOURCER-END -->
