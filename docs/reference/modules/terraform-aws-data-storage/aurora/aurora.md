...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/default_subnet_group_aurora/modules/aurora" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
and encryption. For a list of all available variables and their descriptions, see [variables.tf](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/default_subnet_group_aurora/modules/aurora/variables.tf).
...
See the example [here](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/default_subnet_group_aurora/examples/aurora-with-cross-region-replica) for more details.
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/default_subnet_group_aurora/modules/aurora/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/default_subnet_group_aurora/modules/aurora/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/default_subnet_group_aurora/modules/aurora/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "57c89db2f0b63d7c4d63a4f1ebde8d57"
}
##DOCS-SOURCER-END -->
