...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   Clean up old snapshots automatically using the [lambda-cleanup-snapshots](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-cleanup-snapshots) module.
...
*   [What is Amazon RDS?](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/rds/core-concepts.md#what-is-amazon-rds)

*   [How does this differ from RDS automatic snapshots?](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot/core-concepts.md#how-does-this-differ-from-rds-automatic-snapshots)
...
*   [examples folder](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/examples): The `examples` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
...
*   [How to backup RDS snapshots to a separate AWS account](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot/core-concepts.md#how-do-you-backup-your-rds-snapshots-to-a-separate-aws-account)
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot/readme.adoc",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/pre-commit/modules/lambda-create-snapshot/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "d2eed2481253be61ddfae2239ae2e98a"
}
##DOCS-SOURCER-END -->
