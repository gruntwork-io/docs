...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/lambda-create-snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   Clean up old snapshots automatically using the [lambda-cleanup-snapshots](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/lambda-cleanup-snapshots) module.
...
*   [What is Amazon RDS?](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/rds/core-concepts.md#what-is-amazon-rds)

*   [How does this differ from RDS automatic snapshots?](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/lambda-create-snapshot/core-concepts.md#how-does-this-differ-from-rds-automatic-snapshots)
...
*   [How to backup RDS snapshots to a separate AWS account](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/lambda-create-snapshot/core-concepts.md#how-do-you-backup-your-rds-snapshots-to-a-separate-aws-account)
...
module "lambda_create_snapshot" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/lambda-create-snapshot?ref=v0.40.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/lambda-create-snapshot/readme.adoc",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/lambda-create-snapshot/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.40.1/modules/lambda-create-snapshot/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "768a9fc583d80d6cabaca0fba083fbc3"
}
##DOCS-SOURCER-END -->
