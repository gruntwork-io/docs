...
<VersionBadge repoTitle="Data Storage Modules" version="0.33" lastModifiedVersion="0.31.4"/>

# Database backup

<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/lambda-create-snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   Clean up old snapshots automatically using the [lambda-cleanup-snapshots](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/lambda-cleanup-snapshots) module.
...
*   [What is Amazon RDS?](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/rds/core-concepts.md#what-is-amazon-rds)

*   [How does this differ from RDS automatic snapshots?](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/lambda-create-snapshot/core-concepts.md#how-does-this-differ-from-rds-automatic-snapshots)
...
*   [examples folder](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/examples): The `examples` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
...
*   [How to backup RDS snapshots to a separate AWS account](https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/lambda-create-snapshot/core-concepts.md#how-do-you-backup-your-rds-snapshots-to-a-separate-aws-account)
...
module "lambda_create_snapshot" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/lambda-create-snapshot?ref=v0.33"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/lambda-create-snapshot/readme.adoc",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/lambda-create-snapshot/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v0.33/modules/lambda-create-snapshot/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "a43798a4f922d74188a0fcea02f9d304"
}
##DOCS-SOURCER-END -->
