...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/db-subnet-grou/modules/lambda-copy-shared-snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/db-subnet-grou/modules/lambda-copy-shared-snapshot/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/db-subnet-grou/modules/lambda-copy-shared-snapshot/variables.tf",
