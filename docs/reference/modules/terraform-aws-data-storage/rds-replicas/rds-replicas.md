...
<a href="https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.3.1/modules/rds-replicas" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "rds_replicas" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-data-storage.git//modules/rds-replicas?ref=v1.3.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.3.1/modules/rds-replicas/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-data-storage/tree/v1.3.1/modules/rds-replicas/variables.tf",
