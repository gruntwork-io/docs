...
<VersionBadge repoTitle="Module Server" version="1.0.1" lastModifiedVersion="0.16.1"/>

# Single Server Module

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v1.0.1/modules/single-server" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v1.0.1/modules/single-server/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v1.0.1/modules/single-server/variables.tf",
