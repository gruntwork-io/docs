...
<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/single-server" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "single_server" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-server.git//modules/single-server?ref=v0.15.14"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/single-server/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/single-server/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/single-server/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "b2739059da8c6c4e9131bc0ff7a57825"
}
##DOCS-SOURCER-END -->
