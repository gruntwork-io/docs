...
<VersionBadge repoTitle="Module Server" version="0.16.0" lastModifiedVersion="0.16.0"/>

# Single Server Module

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/single-server" className="link-button" title="View the source code for this module in GitHub.">View Source</a>

<a href="https://github.com/gruntwork-io/terraform-aws-server/releases/tag/v0.16.0" className="link-button" title="Release notes for only versions which impacted this module.">Release Notes</a>
...
module "single_server" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-server.git//modules/single-server?ref=v0.16.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/single-server/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/single-server/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/single-server/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "43411ca9e3bc45c9523f9768cc9f729d"
}
##DOCS-SOURCER-END -->
