...
<VersionBadge repoTitle="Module Server" version="1.0.0" lastModifiedVersion="0.16.1"/>

# Single Server Module

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v1.0.0/modules/single-server" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "single_server" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-server.git//modules/single-server?ref=v1.0.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v1.0.0/modules/single-server/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v1.0.0/modules/single-server/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v1.0.0/modules/single-server/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "03aba15593121ca50fa5eaa2d216dfdc"
}
##DOCS-SOURCER-END -->
