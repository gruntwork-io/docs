...
<VersionBadge repoTitle="Module Server" version="0.15.10" lastModifiedVersion="0.15.4"/>

# Attach ENI Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.10/modules/attach-eni" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [attach-eni example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.10/examples/attach-eni) for how to use these scripts with Terraform.
...
3.  The EC2 instance must have an IAM role with permissions to search ENIs and EC2 tags, as well as attach ENIs (see the
    [attach-eni example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.10/examples/attach-eni))
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.10/modules/attach-eni/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.10/modules/attach-eni/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.10/modules/attach-eni/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "9cdd9ff79e736eccb59cab0d2c588a26"
}
##DOCS-SOURCER-END -->
