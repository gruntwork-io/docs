...
<VersionBadge repoTitle="Module Server" version="0.16.0" lastModifiedVersion="0.15.14"/>

# Attach ENI Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/attach-eni" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [attach-eni example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/examples/attach-eni) for how to use these scripts with Terraform.
...
3.  The EC2 instance must have an IAM role with permissions to search ENIs and EC2 tags, as well as attach ENIs (see the
    [attach-eni example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/examples/attach-eni))
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/attach-eni/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/attach-eni/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/attach-eni/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "beda32f4665b5adcd48828f6f1d88d79"
}
##DOCS-SOURCER-END -->
