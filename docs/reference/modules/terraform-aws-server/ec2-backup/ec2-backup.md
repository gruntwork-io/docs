...
<VersionBadge repoTitle="Module Server" version="0.15.7" lastModifiedVersion="0.15.6"/>

# EC2 Backup Module

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.7/modules/ec2-backup" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "ec_2_backup" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-server.git//modules/ec2-backup?ref=v0.15.7"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.7/modules/ec2-backup/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.7/modules/ec2-backup/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.7/modules/ec2-backup/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "9e2b5f4ddbe20a30ba57c95952c992a7"
}
##DOCS-SOURCER-END -->
