...
<VersionBadge repoTitle="Module Server" version="0.16.0" lastModifiedVersion="0.15.3"/>

# Persistent EBS Volume Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/persistent-ebs-volume" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [persistent-ebs-volume example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/examples/persistent-ebs-volume) for how to use these scripts with
Terraform.
...
3.  The EC2 instance must have an IAM role with permissions to list, attach, and detach volumes (see the
    [persistent-ebs-volume example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/examples/persistent-ebs-volume))
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/persistent-ebs-volume/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/persistent-ebs-volume/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/persistent-ebs-volume/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "a1a5d338001dc336df7b9ce40c53fcdc"
}
##DOCS-SOURCER-END -->
