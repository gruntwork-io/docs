...
<VersionBadge repoTitle="Module Server" version="0.15.14" lastModifiedVersion="0.15.3"/>

# Persistent EBS Volume Scripts

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/persistent-ebs-volume" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [persistent-ebs-volume example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/examples/persistent-ebs-volume) for how to use these scripts with
Terraform.
...
3.  The EC2 instance must have an IAM role with permissions to list, attach, and detach volumes (see the
    [persistent-ebs-volume example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/examples/persistent-ebs-volume))
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/persistent-ebs-volume/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/persistent-ebs-volume/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/persistent-ebs-volume/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "52cedf292cfa96709b589d59146c71a5"
}
##DOCS-SOURCER-END -->
