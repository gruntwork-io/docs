...
<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/route53-helpers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [route53-helpers example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/examples/route53-helpers) for how to use these scripts with Terraform.
...
Check out the [route53-helpers example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/examples/route53-helpers) to see what this looks like in action.


<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/route53-helpers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/route53-helpers/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.15.14/modules/route53-helpers/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "889375a4ca087a5ca2736a793403afcd"
}
##DOCS-SOURCER-END -->
