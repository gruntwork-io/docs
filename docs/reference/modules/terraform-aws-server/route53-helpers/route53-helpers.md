...
<VersionBadge repoTitle="Module Server" version="0.16.0" lastModifiedVersion="0.13.4"/>

# Route 53 Helpers

<a href="https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/route53-helpers" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Check out the [route53-helpers example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/examples/route53-helpers) for how to use these scripts with Terraform.
...
Check out the [route53-helpers example](https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/examples/route53-helpers) to see what this looks like in action.


<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/route53-helpers/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/route53-helpers/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-server/tree/v0.16.0/modules/route53-helpers/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "e2361a603a521579ca25eebb465f6166"
}
##DOCS-SOURCER-END -->
