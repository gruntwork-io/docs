...
<VersionBadge repoTitle="Control Tower" version="0.2.3" lastModifiedVersion="0.2.0"/>

# Account Baseline Security with Control Tower Integration

<a href="https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.2.3/modules/landingzone/control-tower-security-account-baseline" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "control_tower_security_account_baseline" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-control-tower.git//modules/landingzone/control-tower-security-account-baseline?ref=v0.2.3"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.2.3/modules/control-tower-security-account-baseline/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.2.3/modules/control-tower-security-account-baseline/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.2.3/modules/control-tower-security-account-baseline/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "3d5cb1dbb4a30b40fe94bb593258d8c4"
}
##DOCS-SOURCER-END -->
