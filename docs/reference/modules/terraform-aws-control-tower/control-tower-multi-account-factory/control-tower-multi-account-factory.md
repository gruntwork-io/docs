...
<VersionBadge repoTitle="Control Tower" version="0.6.1" lastModifiedVersion="0.6.0"/>

# Control Tower Multi-Account Factory

<a href="https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.6.1/modules/landingzone/control-tower-multi-account-factory" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
the hood, this module uses the [control-tower-account-factory](https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.6.1/modules/control-tower-account-factory) module.
...
module "control_tower_multi_account_factory" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-control-tower.git//modules/landingzone/control-tower-multi-account-factory?ref=v0.6.1"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.6.1/modules/control-tower-multi-account-factory/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.6.1/modules/control-tower-multi-account-factory/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-control-tower/tree/v0.6.1/modules/control-tower-multi-account-factory/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "cffdae84623965670f6a38a84f078a0d"
}
##DOCS-SOURCER-END -->
