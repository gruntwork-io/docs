...
<a href="https://github.com/gruntwork-io/terraform-aws-cache/tree/v1.0.5/modules/redis" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
to [examples/redis_single_instance](https://github.com/gruntwork-io/terraform-aws-cache/tree/v1.0.5/examples/redis_single_instance) as an example.
...
module "redis" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-cache.git//modules/redis?ref=v1.0.5"
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-cache/tree/v1.0.5/modules/redis/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-cache/tree/v1.0.5/modules/redis/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "18ba8ba5a8a0e01929b3c9fcf216272e"
}
##DOCS-SOURCER-END -->
*/}
