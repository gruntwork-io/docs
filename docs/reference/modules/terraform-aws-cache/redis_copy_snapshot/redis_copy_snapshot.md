...
<VersionBadge repoTitle="Cache Modules" version="1.0.5" lastModifiedVersion="0.22.8"/>

# Redis Copy Snapshot Module

<a href="https://github.com/gruntwork-io/terraform-aws-cache/tree/v1.0.5/modules/redis_copy_snapshot" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
You can also refer to [redis_copy_snapshot](https://github.com/gruntwork-io/terraform-aws-cache/tree/v1.0.5/examples/redis_copy_snapshot) module as an example.
...
module "redis_copy_snapshot" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-cache.git//modules/redis_copy_snapshot?ref=v1.0.5"
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-cache/tree/v1.0.5/modules/redis_copy_snapshot/variables.tf",
