...
<VersionBadge repoTitle="VPC Modules" version="0.28.13" lastModifiedVersion="0.22.3"/>

# Port Calculator Module

<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.13/modules/port-range-calculator" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "port_range_calculator" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/port-range-calculator?ref=v0.28.13"
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.13/modules/port-range-calculator/variables.tf",
