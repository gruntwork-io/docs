...
<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.13/modules/vpc-interface-endpoint" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Learn about [Other VPC Core Concepts](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.13/modules//_docs/vpc-core-concepts.md) like subnets and NAT Gateways.
...
module "vpc_interface_endpoint" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-interface-endpoint?ref=v0.28.13"
...
<!-- ##DOCS-SOURCER-START
{
  "originalSources": [
    ...
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.13/modules/vpc-interface-endpoint/variables.tf",
