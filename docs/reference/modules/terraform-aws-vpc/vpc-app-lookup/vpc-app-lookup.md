...
<VersionBadge repoTitle="VPC Modules" version="0.28.6" lastModifiedVersion="0.26.21"/>

# VPC-App Lookup Module

<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.6/modules/vpc-app-lookup" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[`vpc-app` module](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.6/modules/vpc-app), including the VPC ID, subnet IDs, route table IDs, NAT Gateway IDs, and so on.
...
module "vpc_app_lookup" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app-lookup?ref=v0.28.6"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.6/modules/vpc-app-lookup/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.6/modules/vpc-app-lookup/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.6/modules/vpc-app-lookup/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "95693f03020c53fa1e3846d10187896d"
}
##DOCS-SOURCER-END -->
