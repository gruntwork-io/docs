...
<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-app-lookup" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[`vpc-app` module](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-app), including the VPC ID, subnet IDs, route table IDs, NAT Gateway IDs, and so on.
...
module "vpc_app_lookup" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app-lookup?ref=v0.28.14"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-app-lookup/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-app-lookup/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-app-lookup/outputs.tf"
  ],
