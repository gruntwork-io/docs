...
<VersionBadge repoTitle="VPC Modules" version="0.26.4" lastModifiedVersion="0.26.4"/>

# IPv6

<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.4/modules/vpc-app" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
*   The only way to reach this VPC is from the public Internet via a publicly exposed sevice, or via the [mgmt VPC](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.4/modules/vpc-mgmt),
    which uses [VPC Peering](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.4/modules/vpc-peering) to make this VPC accessible from the mgmt VPC.
...
Learn about [Other VPC Core Concepts](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.4/modules//_docs/vpc-core-concepts.md) like subnets, NAT Gateways, and VPC Endpoints.
...
module "vpc_app" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app?ref=v0.26.4"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.4/modules/vpc-app/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.4/modules/vpc-app/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.4/modules/vpc-app/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "6f62a9b6f9d6e0e393af56cd8cf443ee"
}
##DOCS-SOURCER-END -->
