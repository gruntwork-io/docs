...
module "vpc_app" {
  ...
  # (Optional) The private IP address to associate with the NAT Gateway. If not
  # specified, one will be assigned via DHCP within the VPC.
  nat_private_ip = null
...
<HclListItem name="nat_private_ip" requirement="optional" type="string">
<HclListItemDescription>

(Optional) The private IP address to associate with the NAT Gateway. If not specified, one will be assigned via DHCP within the VPC.
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "31c644f5e195987e4e44b85ba30fe515"
}
##DOCS-SOURCER-END -->
