...
<VersionBadge repoTitle="VPC Modules" version="0.24.0" lastModifiedVersion="0.22.8"/>

# VPC-App Terraform Module

<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules/vpc-app" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
Jenkins or InfluxDB should be in a "mgmt" VPC. (See the [vpc-mgmt](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules/vpc-mgmt) module.)
...
*   The only way to reach this VPC is from the public Internet via a publicly exposed sevice, or via the [mgmt VPC](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules/vpc-mgmt),
    which uses [VPC Peering](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules/vpc-peering) to make this VPC accessible from the mgmt VPC.
...
Learn about [Other VPC Core Concepts](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules//_docs/vpc-core-concepts.md) like subnets, NAT Gateways, and VPC Endpoints.
...
module "vpc_app" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app?ref=v0.24.0"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules/vpc-app/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules/vpc-app/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.24.0/modules/vpc-app/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "faffb9bd0bdc65d6881f88f7add6462d"
}
##DOCS-SOURCER-END -->
