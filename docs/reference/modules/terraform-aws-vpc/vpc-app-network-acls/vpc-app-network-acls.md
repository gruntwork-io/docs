...
<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.7/modules/vpc-app-network-acls" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
[vpc-app](https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.7/modules/vpc-app) module. The ACLs enforce the following security settings (based on [A Reference VPC
...
module "vpc_app_network_acls" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-app-network-acls?ref=v0.26.7"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.7/modules/vpc-app-network-acls/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.7/modules/vpc-app-network-acls/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.26.7/modules/vpc-app-network-acls/outputs.tf"
  ],
  "sourcePlugin": "module-catalog-api",
  "hash": "728dc6a4cbdc07a6784c8e3175ac22a6"
}
##DOCS-SOURCER-END -->
