...
<a href="https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-flow-logs" className="link-button" title="View the source code for this module in GitHub.">View Source</a>
...
module "vpc_flow_logs" {
  ...
  source = "git::git@github.com:gruntwork-io/terraform-aws-vpc.git//modules/vpc-flow-logs?ref=v0.28.14"
...
{
  "originalSources": [
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-flow-logs/readme.md",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-flow-logs/variables.tf",
    "https://github.com/gruntwork-io/terraform-aws-vpc/tree/v0.28.14/modules/vpc-flow-logs/outputs.tf"
  ],
