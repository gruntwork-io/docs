...
Pipelines supports optional feature flags that allow you to enable or disable specific behaviors. You can configure these flags by setting them as environment variables within your [HCL](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#env-block) or [YAML](/docs/terragrunt-scale/pipelines/reference/configurations#env) configuration files.
