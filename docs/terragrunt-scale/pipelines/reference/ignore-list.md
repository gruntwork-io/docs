...
Pipelines supports ignoring files by setting the Ignore List [HCL](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#ignore_list) or [YAML](/docs/terragrunt-scale/pipelines/reference/configurations#ignore-list) configuration value.
