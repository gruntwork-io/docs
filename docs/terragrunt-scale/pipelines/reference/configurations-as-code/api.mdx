...
<br/>
For more information on importing accounts from `accounts.yml` [click here](/docs/terragrunt-scale/pipelines/reference/configurations-as-code#aws-blocks)
<br/>
...
A comma separate list of ignore filters to exclude from pipelines runs. See the full documentation [here](/docs/terragrunt-scale/pipelines/reference/ignore-list)
...
You can learn more about how custom authentication works in the [Custom Authentication](/docs/terragrunt-scale/pipelines/concepts/cloud-auth/custom) documentation.
