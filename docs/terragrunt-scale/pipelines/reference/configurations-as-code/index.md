...
We recommend reviewing our [concepts page](/docs/terragrunt-scale/pipelines/concepts/hcl-config-language) on the HCL language to ensure familiarity with its features before configuring Pipelines.
:::
...
[Full Reference for Environment Blocks](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#environment-block)
...
[Full Reference for AWS Blocks](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#aws-block)
...
[Full Reference for Repository Blocks](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#repository-block)
...
[Full Reference for Unit Blocks](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#unit-block)
...
[Full Reference for Filter Blocks](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#filter-block)
...
[Full Reference for Authentication Blocks](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#authentication-block)
...
[Full Reference for Environment Variables Block](/docs/terragrunt-scale/pipelines/reference/configurations-as-code/api#env-block)
