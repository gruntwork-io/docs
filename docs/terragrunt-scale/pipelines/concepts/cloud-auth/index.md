...
- [AWS](/docs/terragrunt-scale/pipelines/concepts/cloud-auth/aws) - AWS authentication using OIDC
- [Azure](/docs/terragrunt-scale/pipelines/concepts/cloud-auth/azure) - Azure authentication using OIDC
- [Custom](/docs/terragrunt-scale/pipelines/concepts/cloud-auth/custom) - Custom authentication you can implement yourself
