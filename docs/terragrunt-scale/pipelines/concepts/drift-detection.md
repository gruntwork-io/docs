...
For more information on detecting and resolving drift, see [Setting up Drift Detection](/docs/terragrunt-scale/pipelines/configuration/driftdetection) and [Running Drift Detection](/docs/terragrunt-scale/pipelines/guides/running-drift-detection).
