...
To learn more about how Pipelines authenticates to the cloud, read the [Cloud Authentication](/docs/terragrunt-scale/pipelines/concepts/cloud-auth/index.md) documentation.
