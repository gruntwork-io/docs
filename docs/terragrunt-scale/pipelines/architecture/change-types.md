...
For more information about how Pipelines handles changes to non-IaC file dependencies, see the [File Dependencies guide](/docs/terragrunt-scale/pipelines/guides/file-dependencies).
