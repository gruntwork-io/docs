...
- `pipelines-drift-detection.yml` - (Enterprise only) Used for [Pipelines Drift Detection](/docs/terragrunt-scale/pipelines/concepts/drift-detection) in all repositories with Drift Detection installed.
...
If you are using [Gruntwork Account Factory](/docs/aws-accelerator/account-factory/concepts/), the following workflows are typically present:
...
### infrastructure-live-delegated ([Vended Delegated Repositories](/docs/aws-accelerator/account-factory/guides/delegated-repositories))
