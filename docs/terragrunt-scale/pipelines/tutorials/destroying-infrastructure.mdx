...
- Pipelines installed in a GitHub/GitLab repository. Refer to [Setup & Installation](/docs/terragrunt-scale/pipelines/installation/overview) for details.
