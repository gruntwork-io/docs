...
For standalone installations that did not use the `infrastructure-live-root` repository template, follow the [Installing Drift Detection Guide](/docs/terragrunt-scale/pipelines/guides/installing-drift-detection.md) to enable Drift Detection.
