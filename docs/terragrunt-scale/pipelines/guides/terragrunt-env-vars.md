...
You can configure Pipelines to pass additional environment variables to Terragrunt using the [env configuration option](/docs/terragrunt-scale/pipelines/reference/configurations#env) in `.gruntwork/config.yml`.
