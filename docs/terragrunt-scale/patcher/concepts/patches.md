...
Refer to our guide on [promotion workflows](/docs/terragrunt-scale/patcher/guides/promotion-workflows) for more details.
...
```
For a complete list of options, refer to the [Patcher CLI Reference](/docs/terragrunt-scale/patcher/reference/index.md#update).
