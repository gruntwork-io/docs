...
* [Patcher installed](/docs/terragrunt-scale/patcher/installation/) either locally or as a GitHub Actions workflow in your repository
...
At this point, if you are a [Gruntwork Pipelines](/docs/terragrunt-scale/pipelines/concepts/overview) customer, Pipelines will automatically plan the change and post the results as a comment. If the results look good, you can merge the pull request to apply and finalize the change. 
