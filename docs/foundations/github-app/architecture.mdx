...
1. **GitHub App**: The Gruntwork.io GitHub App itself, which is installed in your GitHub organization.
2. **Gruntwork.io App Service**: The service that interacts with the GitHub API on behalf of the Gruntwork.io GitHub App.
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "01b34c57006089228900abac3ad70107"
}
##DOCS-SOURCER-END -->
