...
2. **Gruntwork.io API**: The API that interacts with the GitHub API on behalf of the Gruntwork.io GitHub App.
3. **Clients**: Clients that interact with the Gruntwork.io API to perform operations on GitHub resources.
...
<!-- ##DOCS-SOURCER-START
{
  ...
  "hash": "4e176c10e1f61b336dc546faa30101a5"
}
##DOCS-SOURCER-END -->
