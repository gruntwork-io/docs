...
### <a name="upgrade-modules-for-compatibility-with-terraform-012x"></a>Upgrade modules for compatibility with Terraform 0.12.x
...
#### <a name="install-and-setup-terraform-0-12"></a>Install and setup Terraform 0.12
...
##### <a name="using-homebrew-to-manage-multiple-terraform-versions"></a>Using homebrew to manage multiple terraform versions
...
##### <a name="using-tfenv-to-manage-multiple-terraform-versions"></a>Using tfenv to manage multiple terraform versions
