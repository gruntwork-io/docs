...
:::tip
We recommend creating two machine users for this use case, but you can adjust based on your organization's needs. Ensure the correct tokens are created and the permissions for the machine users and tokens are appropriate for their required access.
